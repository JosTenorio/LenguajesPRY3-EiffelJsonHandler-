...
extern EIF_TYPED_VALUE F370_2083(EIF_REFERENCE);
extern void F370_4890(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F370_2083 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 369, Current, 0, 0, 3801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {FINITE}._invariant */
void F370_4890 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 369, Current, 0, 4889);
	RTSA(dtype);
	RTME(dtype, 0);
