...
extern EIF_TYPED_VALUE F395_1830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F395_1830 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 394, Current, 0, 0, 1928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(394, Current, 1928);
	RTIV(Current, RTAL);
