...
extern void F366_2015(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F366_2016(EIF_REFERENCE);
extern EIF_TYPED_VALUE F366_2017(EIF_REFERENCE);
extern EIF_TYPED_VALUE F366_2018(EIF_REFERENCE);
...
void F366_2015 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 365, Current, 0, 1, 3401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(365, Current, 3401);
	RTCC(arg1, 365, l_feature_name, 1, RTWCT(1792, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1792, 0xF800016C, 0); /* target */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F366_2016 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F366_2017 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 365, Current, 0, 0, 3403);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(365, Current, 3403);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F366_2018 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
