...
extern void F394_2004(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F394_2004 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 393, Current, 0, 1, 3346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(393, Current, 3346);
	RTCC(arg1, 393, l_feature_name, 1, RTWCT(1800, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1800, 0xF8000188, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 393, Current, 0, 0, 3348);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(393, Current, 3348);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 393, Current, 0, 0, 3349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(393, Current, 3349);
	RTIV(Current, RTAL);
	RTHOOK(1);
