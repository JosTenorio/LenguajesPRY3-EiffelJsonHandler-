...
extern EIF_TYPED_VALUE F378_2033(EIF_REFERENCE);
extern EIF_TYPED_VALUE F378_2034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F378_2035(EIF_REFERENCE);
extern void F378_2036(EIF_REFERENCE);
extern void F378_2037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F378_2039(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F378_2033 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 377, Current, 0, 0, 2805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(377, Current, 2805);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F378_2034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F378_2035 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 377, Current, 0, 0, 2807);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(377, Current, 2807);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F378_2036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 377, Current, 0, 0, 2808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(377, Current, 2808);
	RTIV(Current, RTAL);
...
void F378_2037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 377, Current, 0, 0, 2809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(377, Current, 2809);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F378_2039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 377, Current, 2, 1, 2810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(377, Current, 2810);
	{
