...
extern EIF_TYPED_VALUE F384_1985(EIF_REFERENCE);
extern void F384_5057(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F384_1985 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 383, Current, 0, 0, 3044);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(383, Current, 3044);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F384_5057 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 383, Current, 0, 5056);
	RTSA(dtype);
	RTME(dtype, 0);
