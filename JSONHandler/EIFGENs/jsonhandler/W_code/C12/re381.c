...
extern EIF_TYPED_VALUE F381_2087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F381_2088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F381_2089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F381_2090(EIF_REFERENCE);
extern void F381_2091(EIF_REFERENCE);
extern void F381_4892(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F381_2087 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F381_2088 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F381_2089 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 380, Current, 0, 0, 3853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 3853);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F381_2090 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 380, Current, 0, 0, 3854);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 3854);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F381_2091 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 380, Current, 0, 0, 3855);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 3855);
	RTIV(Current, RTAL);
...
void F381_4892 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 380, Current, 0, 4891);
	RTSA(dtype);
	RTME(dtype, 0);
