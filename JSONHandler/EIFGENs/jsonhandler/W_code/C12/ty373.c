...
extern EIF_TYPED_VALUE F373_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F373_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 372, Current, 0, 0, 2016);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(372, Current, 2016);
	RTIV(Current, RTAL);
