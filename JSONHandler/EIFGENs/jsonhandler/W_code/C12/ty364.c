...
extern EIF_TYPED_VALUE F364_1931(EIF_REFERENCE);
...
EIF_TYPED_VALUE F364_1931 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 363, Current, 0, 0, 2702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(363, Current, 2702);
	RTIV(Current, RTAL);
