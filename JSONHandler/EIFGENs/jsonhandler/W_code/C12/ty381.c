...
extern EIF_TYPED_VALUE F381_1916(EIF_REFERENCE);
...
EIF_TYPED_VALUE F381_1916 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 380, Current, 0, 0, 2015);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 2015);
	RTIV(Current, RTAL);
