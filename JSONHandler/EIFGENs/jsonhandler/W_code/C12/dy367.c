...
extern void F367_2657(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2659(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2660(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2664(EIF_REFERENCE);
...
void F367_2657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 1, 1, 4982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 4982);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		up1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2191, dtype))(Current, up1x);
	} else {
		RTHOOK(5);
...
void F367_2659 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 4983);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 4983);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_p);
		up1 = tp1;
...
void F367_2660 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 4984);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 4984);
	RTCC(arg1, 366, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F367_2664 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 366, Current, 0, 0, 4985);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 4985);
	RTIV(Current, RTAL);
	RTHOOK(1);
