...
extern EIF_TYPED_VALUE F378_2070(EIF_REFERENCE);
extern void F378_5147(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F378_2070 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 377, Current, 0, 0, 3115);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(377, Current, 3115);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F378_5147 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 377, Current, 0, 5146);
	RTSA(dtype);
	RTME(dtype, 0);
