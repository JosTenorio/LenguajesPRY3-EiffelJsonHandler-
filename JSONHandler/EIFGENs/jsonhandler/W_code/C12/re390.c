...
extern EIF_TYPED_VALUE F390_2420(EIF_REFERENCE);
extern void F390_5064(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 3694);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(389, Current, 3694);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F390_2420 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 3692);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(389, Current, 3692);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F390_5064 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 389, Current, 0, 5063);
	RTSA(dtype);
	RTME(dtype, 0);
