...
extern EIF_TYPED_VALUE F369_2504(EIF_REFERENCE);
extern EIF_TYPED_VALUE F369_2507(EIF_REFERENCE);
extern void F369_5155(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F369_2504 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 368, Current, 0, 0, 3777);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(368, Current, 3777);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F369_2507 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 368, Current, 0, 0, 3778);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(368, Current, 3778);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F369_5155 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 368, Current, 0, 5154);
	RTSA(dtype);
	RTME(dtype, 0);
