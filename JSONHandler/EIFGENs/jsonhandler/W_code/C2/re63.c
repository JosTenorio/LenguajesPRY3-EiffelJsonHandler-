...
extern EIF_TYPED_VALUE F63_1125(EIF_REFERENCE);
extern EIF_TYPED_VALUE F63_1126(EIF_REFERENCE);
...
/* {RESCUE_FAILURE}.code */
EIF_TYPED_VALUE F63_1125 (EIF_REFERENCE Current)
{
	GTCX
...
/* {RESCUE_FAILURE}.tag */
RTOID (F63_1126)
EIF_TYPED_VALUE F63_1126 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 62, Current, 0, 0, 1204);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
