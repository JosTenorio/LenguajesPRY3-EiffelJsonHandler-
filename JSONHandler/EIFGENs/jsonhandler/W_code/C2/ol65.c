...
extern EIF_TYPED_VALUE F65_1123(EIF_REFERENCE);
...
/* {OLD_VIOLATION}.code */
EIF_TYPED_VALUE F65_1123 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 64, Current, 0, 0, 1201);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 64, Current, 0, 0, 1202);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
