...
extern EIF_TYPED_VALUE F55_1090(EIF_REFERENCE);
...
RTOID (F55_1090)
EIF_TYPED_VALUE F55_1090 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 54, Current, 0, 0, 1168);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(54, Current, 1168);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
