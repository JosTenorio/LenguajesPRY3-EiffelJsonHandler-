...
extern EIF_TYPED_VALUE F62_1120(EIF_REFERENCE);
extern EIF_TYPED_VALUE F62_1121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F62_1120 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1198);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F62_1121)
EIF_TYPED_VALUE F62_1121 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1199);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
