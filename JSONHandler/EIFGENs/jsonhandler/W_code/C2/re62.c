...
extern EIF_TYPED_VALUE F62_1124(EIF_REFERENCE);
...
RTOID (F62_1124)
EIF_TYPED_VALUE F62_1124 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1202);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(61, Current, 1202);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
