...
EIF_TYPED_VALUE F52_986 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 51, Current, 0, 0, 1068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(643, 27))(Current)).it_i4);
...
EIF_TYPED_VALUE F52_987 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(937,Dtype(Current)));
	return r;
}
...
#define arg1 arg1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 937, 0x10000000, 1); /* error_code */
	*(EIF_INTEGER_32 *)(Current + RTWA(937, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
