...
extern EIF_TYPED_VALUE F52_1089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F52_1090(EIF_REFERENCE);
...
EIF_TYPED_VALUE F52_1089 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 51, Current, 0, 0, 1167);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(51, Current, 1167);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F52_1090)
EIF_TYPED_VALUE F52_1090 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 51, Current, 0, 0, 1168);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(51, Current, 1168);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
