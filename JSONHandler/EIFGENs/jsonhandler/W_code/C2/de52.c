...
extern EIF_TYPED_VALUE F52_1091(EIF_REFERENCE);
...
RTOID (F52_1091)
EIF_TYPED_VALUE F52_1091 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 51, Current, 0, 0, 1169);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(51, Current, 1169);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
