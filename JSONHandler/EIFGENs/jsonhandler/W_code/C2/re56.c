...
extern EIF_TYPED_VALUE F56_996(EIF_REFERENCE);
extern EIF_TYPED_VALUE F56_997(EIF_REFERENCE);
...
EIF_TYPED_VALUE F56_996 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 55, Current, 0, 0, 1078);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(637, 27))(Current)).it_i4);
...
RTOID (F56_997)
EIF_TYPED_VALUE F56_997 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 55, Current, 0, 0, 1079);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
