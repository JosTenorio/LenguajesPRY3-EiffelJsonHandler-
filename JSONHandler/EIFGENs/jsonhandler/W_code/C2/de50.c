...
extern EIF_TYPED_VALUE F50_1000(EIF_REFERENCE);
extern EIF_TYPED_VALUE F50_1001(EIF_REFERENCE);
...
EIF_TYPED_VALUE F50_1000 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 49, Current, 0, 0, 1075);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F50_1001)
EIF_TYPED_VALUE F50_1001 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 49, Current, 0, 0, 1076);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
