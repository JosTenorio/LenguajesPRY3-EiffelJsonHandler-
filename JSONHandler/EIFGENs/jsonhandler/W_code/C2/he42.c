...
extern void F42_879(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_880(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F42_884(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F42_885(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F42_886(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F42_887(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F42_888(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_889(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_890(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F42_897(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_898(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_899(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_900(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_901(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_902(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_904(EIF_REFERENCE);
...
void F42_879 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F42_880 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 41, Current, 4, 1, 962);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 962);
	RTCC(arg1, 41, l_feature_name, 1, eif_new_type(175, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F42_882 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F42_884 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 41, Current, 0, 1, 966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 966);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F42_885 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 41, Current, 8, 2, 967);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 967);
	RTCC(arg1, 41, l_feature_name, 1, eif_new_type(170, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
	...
	if (EIF_TEST(loc7)) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)) < loc4)) {
				RTHOOK(10);
				RTDBGAA(Current, dtype, 858, 0x08000000, 1); /* internal_lookahead */
				ui4_1 = (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L));
				tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2099, "item", loc2))(loc2, ui4_1x)).it_c1);
				*(EIF_CHARACTER_8 *)(Current + RTWA(858, dtype)) = (EIF_CHARACTER_8) tc1;
			} else {
				RTHOOK(11);
				RTDBGAA(Current, dtype, 858, 0x08000000, 1); /* internal_lookahead */
				*(EIF_CHARACTER_8 *)(Current + RTWA(858, dtype)) = (EIF_CHARACTER_8) (EIF_CHARACTER_8) ' ';
			}
			RTHOOK(12);
			ui4_1 = loc1;
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2099, "item", loc2))(loc2, ui4_1x)).it_c1);
...
void F42_886 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 41, Current, 3, 1, 968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 968);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(811, dtype));
	...
	if ((EIF_BOOLEAN) (loc3 <= ((EIF_INTEGER_32) 5L))) {
		...
		switch (loc3) {
			case 0L:
				RTHOOK(4);
				tc1 = *(EIF_CHARACTER_8 *)(Current + RTWA(858, dtype));
				tc2 = *(EIF_CHARACTER_8 *)(Current + RTWA(858, dtype));
				if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'x') || (EIF_BOOLEAN)(tc2 == (EIF_CHARACTER_8) 'X'))) || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '&'))) {
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-') || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+'))) {
						...
						*(EIF_CHARACTER_8 *)tr1 = arg1;
						tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3103, "is_hexa_digit", tr1))(tr1)).it_b);
						if (tb1) {
							RTHOOK(12);
							RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
							loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
							RTHOOK(13);
							RTDBGAA(Current, dtype, 861, 0x3C000000, 1); /* part1 */
							*(EIF_NATURAL_64 *)(Current + RTWA(861, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
							RTHOOK(14);
							if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (arg1 >= (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) (arg1 <= (EIF_CHARACTER_8) '9'))) {
								RTHOOK(15);
								RTDBGAA(Current, dtype, 862, 0x3C000000, 1); /* part2 */
								ti4_1 = (EIF_INTEGER_32) (arg1);
								tu8_1 = (EIF_NATURAL_64) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
								*(EIF_NATURAL_64 *)(Current + RTWA(862, dtype)) = (EIF_NATURAL_64) tu8_1;
							} else {
								RTHOOK(16);
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current + RTWA(861, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(860, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
						RTNHOOK(31,1);
						tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(861, dtype));
						uu8_1 = tu8_1;
						tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(862, dtype));
						uu8_2 = tu8_2;
						ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(803, dtype));
						ui4_1 = ti4_1;
					...
					if (tb1) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(859, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
						RTHOOK(33);
						RTDBGAA(Current, dtype, 862, 0x3C000000, 1); /* part2 */
						*(EIF_NATURAL_64 *)(Current + RTWA(862, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
						RTHOOK(34);
						RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
			...
			case 3L:
				...
				*(EIF_CHARACTER_8 *)tr1 = arg1;
				...
				if (tb1) {
					...
					tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(862, dtype));
					loc2 = (EIF_NATURAL_64) tu8_1;
					RTHOOK(55);
					RTDBGAA(Current, dtype, 861, 0x3C000000, 1); /* part1 */
					tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(861, dtype));
					tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(862, dtype));
					*(EIF_NATURAL_64 *)(Current + RTWA(861, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_NATURAL_64) (tu8_1 * (EIF_NATURAL_64) ((EIF_INTEGER_32) 16L)) + tu8_2);
					RTHOOK(56);
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (arg1 >= (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) (arg1 <= (EIF_CHARACTER_8) '9'))) {
						RTHOOK(57);
						RTDBGAA(Current, dtype, 862, 0x3C000000, 1); /* part2 */
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(859, dtype)) = (EIF_BOOLEAN) tb1;
						...
						if (tb1) {
							RTHOOK(65);
							RTDBGAA(Current, dtype, 861, 0x3C000000, 1); /* part1 */
							*(EIF_NATURAL_64 *)(Current + RTWA(861, dtype)) = (EIF_NATURAL_64) loc1;
							RTHOOK(66);
							RTDBGAA(Current, dtype, 862, 0x3C000000, 1); /* part2 */
							*(EIF_NATURAL_64 *)(Current + RTWA(862, dtype)) = (EIF_NATURAL_64) loc2;
							RTHOOK(67);
							RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
							loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
						}
...
EIF_TYPED_VALUE F42_887 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 41, Current, 0, 1, 969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 969);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
...
EIF_TYPED_VALUE F42_888 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 970);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(811, dtype));
...
EIF_TYPED_VALUE F42_889 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 971);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 971);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(811, dtype));
...
EIF_TYPED_VALUE F42_890 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 972);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(812, dtype));
...
EIF_TYPED_VALUE F42_891 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 973);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(812, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F42_892 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 974);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(812, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F42_893 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 975);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(812, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F42_894 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 976);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 976);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(812, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F42_895 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 977);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F42_896 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 978);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F42_897 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 979);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 979);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F42_898 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 980);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 980);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x38000000, 1,0); /* Result */
	tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(861, dtype));
...
EIF_TYPED_VALUE F42_899 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 981);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 981);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F42_900 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
	r.it_c1 = *(EIF_CHARACTER_8 *)(Current + RTWA(858,Dtype(Current)));
	return r;
}


/* {HEXADECIMAL_STRING_TO_INTEGER_CONVERTER}.internal_overflowed */
EIF_TYPED_VALUE F42_901 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
RTOID (F42_902)
EIF_TYPED_VALUE F42_902 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 984);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 984);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F42_903 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(861,Dtype(Current)));
	return r;
}


/* {HEXADECIMAL_STRING_TO_INTEGER_CONVERTER}.part2 */
EIF_TYPED_VALUE F42_904 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(862,Dtype(Current)));
	return r;
}
