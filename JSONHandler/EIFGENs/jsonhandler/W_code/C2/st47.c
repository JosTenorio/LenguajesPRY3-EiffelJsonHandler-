...
extern void F47_980(EIF_REFERENCE);
extern EIF_TYPED_VALUE F47_981(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F47_985(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F47_992(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F47_993(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F47_980 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F47_981 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 46, Current, 0, 1, 1070);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ui4_1 = arg1;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(906, dtype))(Current, ui4_1x)).it_b);
...
EIF_TYPED_VALUE F47_983 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 46, Current, 0, 0, 1072);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F47_985 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 46, Current, 4, 1, 1074);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F47_987 (EIF_REFERENCE Current)
{
	...
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(952, dtype))(Current)).it_b);
	Result = (EIF_BOOLEAN) tb1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_TYPED_VALUE F47_990 (EIF_REFERENCE Current)
{
	...
	if (tb1) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 961, 0x10000000, 1); /* exponent */
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(961, dtype));
		*(EIF_INTEGER_32 *)(Current + RTWA(961, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) -ti4_1;
	}
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(964, dtype));
	if (tb1) {
		RTHOOK(4);
		RTDBGAA(Current, dtype, 958, 0x20000000, 1); /* natural_part */
		tr8_2 = *(EIF_REAL_64 *)(Current + RTWA(959, dtype));
		tr8_3 = *(EIF_REAL_64 *)(Current + RTWA(960, dtype));
		(*(EIF_REAL_64 *)(Current + RTWA(958, dtype))) += (EIF_REAL_64) ((EIF_REAL_64) (tr8_2) /  (EIF_REAL_64) (tr8_3));
	}
	RTHOOK(5);
...
EIF_TYPED_VALUE F47_991 (EIF_REFERENCE Current)
{
	...
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(956, dtype))(Current)).it_r8);
	RTNHOOK(1,1);
...
void F47_992 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	*(EIF_REAL_64 *)(Current + RTWA(958, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 959, 0x20000000, 1); /* fractional_part */
	tr8_1 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
	*(EIF_REAL_64 *)(Current + RTWA(959, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 960, 0x20000000, 1); /* fractional_divider */
	tr8_1 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
	*(EIF_REAL_64 *)(Current + RTWA(960, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(8);
	RTDBGAA(Current, dtype, 961, 0x10000000, 1); /* exponent */
	*(EIF_INTEGER_32 *)(Current + RTWA(961, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(9);
	RTDBGAA(Current, dtype, 962, 0x04000000, 1); /* is_negative */
	*(EIF_BOOLEAN *)(Current + RTWA(962, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(10);
	RTDBGAA(Current, dtype, 963, 0x04000000, 1); /* has_negative_exponent */
	*(EIF_BOOLEAN *)(Current + RTWA(963, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(11);
	RTDBGAA(Current, dtype, 964, 0x04000000, 1); /* has_fractional_part */
	*(EIF_BOOLEAN *)(Current + RTWA(964, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(12);
	RTDBGAA(Current, dtype, 965, 0x04000000, 1); /* needs_digit */
...
void F47_993 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 46, Current, 8, 2, 1059);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
		...
		if (EIF_TEST(loc8)) {
			...
			for (;;) {
				...
				if (tb1) {
					...
					RTHOOK(17);
					RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
					*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
				}
				RTHOOK(18);
				RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
				loc1++;
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 46, Current, 0, 1, 1060);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	switch (ti4_1) {
		case 0L:
			...
			if (tb1) {
				RTHOOK(3);
				RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
				*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
				RTHOOK(4);
				RTDBGAA(Current, dtype, 958, 0x20000000, 1); /* natural_part */
						...
						*(EIF_BOOLEAN *)(Current + RTWA(962, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
						...
						if (tb1) {
							...
							if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '.')) {
								RTHOOK(12);
								RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
								*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
								RTHOOK(13);
								RTDBGAA(Current, dtype, 965, 0x04000000, 1); /* needs_digit */
		...
		case 2L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(958, dtype)) = (EIF_REAL_64) (EIF_REAL_64) ((EIF_REAL_64) ((EIF_REAL_64) (tr8_1 * (EIF_REAL_64) 10.0) + tr8_2) - tr8_3);
			} else {
				RTHOOK(24);
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '.')) {
					RTHOOK(25);
					...
					*(EIF_BOOLEAN *)(Current + RTWA(965, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
					...
					if (tb1) {
						RTHOOK(28);
						RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 8L);
					} else {
						RTHOOK(29);
						...
						if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
							RTHOOK(30);
							RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
							*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
						} else {
							RTHOOK(31);
							RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
							*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 3L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(959, dtype)) = (EIF_REAL_64) tr8_1;
				RTHOOK(36);
				RTDBGAA(Current, dtype, 960, 0x20000000, 1); /* fractional_divider */
				*(EIF_REAL_64 *)(Current + RTWA(960, dtype)) = (EIF_REAL_64) (EIF_REAL_64) 10.0;
				RTHOOK(37);
				RTDBGAA(Current, dtype, 965, 0x04000000, 1); /* needs_digit */
				*(EIF_BOOLEAN *)(Current + RTWA(965, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			} else {
				...
				tc1 = eif_builtin_CHARACTER_8_as_lower__c1_c1(arg1);
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
					tb2 = *(EIF_BOOLEAN *)(Current + RTWA(965, dtype));
					tb1 = (EIF_BOOLEAN) !tb2;
				}
				if (tb1) {
					RTHOOK(39);
		...
		case 4L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(959, dtype)) = (EIF_REAL_64) (EIF_REAL_64) ((EIF_REAL_64) (tr8_1 * (EIF_REAL_64) 10.0) + tr8_2);
				RTHOOK(46);
				RTDBGAA(Current, dtype, 960, 0x20000000, 1); /* fractional_divider */
				(*(EIF_REAL_64 *)(Current + RTWA(960, dtype))) *= (EIF_REAL_64) 10.0;
			} else {
				RTHOOK(47);
				tc1 = eif_builtin_CHARACTER_8_as_lower__c1_c1(arg1);
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
		...
		case 5L:
			...
			if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-')) {
				...
				*(EIF_BOOLEAN *)(Current + RTWA(963, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(55);
				RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
				*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
			} else {
				RTHOOK(56);
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+')) {
					RTHOOK(57);
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
					...
					if (tb1) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(965, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
						RTHOOK(60);
						RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
						RTHOOK(61);
						RTDBGAA(Current, dtype, 961, 0x10000000, 1); /* exponent */
						ti4_1 = (EIF_INTEGER_32) (arg1);
						*(EIF_INTEGER_32 *)(Current + RTWA(961, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
					} else {
						RTHOOK(62);
						RTDBGAA(Current, dtype, 932, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(932, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 7L:
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(961, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (ti4_1 * ((EIF_INTEGER_32) 10L)) + ti4_2) - ((EIF_INTEGER_32) 48L));
			} else {
				RTHOOK(70);
				tb1 = '\0';
				tb2 = *(EIF_BOOLEAN *)(Current + RTWA(915, dtype));
...
EIF_TYPED_VALUE F47_998 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(961,Dtype(Current)));
	return r;
}
