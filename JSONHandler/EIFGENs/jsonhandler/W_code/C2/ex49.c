...
extern EIF_TYPED_VALUE F49_1031(EIF_REFERENCE);
...
RTOID (F49_1031)
EIF_TYPED_VALUE F49_1031 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1109);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
