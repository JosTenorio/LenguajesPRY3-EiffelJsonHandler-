...
extern EIF_TYPED_VALUE F59_1024(EIF_REFERENCE);
...
EIF_TYPED_VALUE F59_1024 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 58, Current, 0, 0, 1100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(58, Current, 1100);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 58, Current, 0, 0, 1101);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
