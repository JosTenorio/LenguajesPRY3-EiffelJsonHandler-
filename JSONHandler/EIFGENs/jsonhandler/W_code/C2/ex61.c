...
extern EIF_TYPED_VALUE F61_1121(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1122(EIF_REFERENCE);
...
EIF_TYPED_VALUE F61_1121 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1199);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1199);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F61_1122)
EIF_TYPED_VALUE F61_1122 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1200);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1200);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
