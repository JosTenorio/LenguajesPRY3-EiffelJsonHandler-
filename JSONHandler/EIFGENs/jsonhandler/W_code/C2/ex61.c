...
extern EIF_TYPED_VALUE F61_1117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F61_1117 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1195);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1195);
	RTIV(Current, RTAL);
	RTHOOK(1);
