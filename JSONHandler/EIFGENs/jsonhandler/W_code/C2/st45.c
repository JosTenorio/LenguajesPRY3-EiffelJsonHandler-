...
extern EIF_TYPED_VALUE F45_954(EIF_REFERENCE);
extern void F45_5133(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F45_945 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(924,Dtype(Current)));
	return r;
}
...
#define arg1 arg1x.it_b
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 915, 0x04000000, 1); /* trailing_separators_acceptable */
...
#define arg1 arg1x.it_b
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 916, 0x04000000, 1); /* leading_separators_acceptable */
...
#define ur1 ur1x.it_r
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ur1 = RTCCL(arg1);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(919, dtype))(Current, ur1x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
...
EIF_TYPED_VALUE F45_954 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(933,Dtype(Current)));
	return r;
}


/* {STRING_TO_NUMERIC_CONVERTOR}._invariant */
void F45_5133 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 44, Current, 0, 5132);
	RTSA(dtype);
	RTME(dtype, 0);
