...
extern void F43_884(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_885(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F43_886(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_887(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_888(EIF_REFERENCE);
extern void F43_889(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F43_890(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F43_891(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F43_892(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F43_893(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_894(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_895(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_896(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_897(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_898(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_899(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_900(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_901(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_902(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_904(EIF_REFERENCE);
extern EIF_TYPED_VALUE F43_905(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F43_909(EIF_REFERENCE);
...
void F43_884 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F43_885 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 42, Current, 4, 1, 967);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 967);
	RTCC(arg1, 42, l_feature_name, 1, eif_new_type(179, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F43_886 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(864, dtype));
...
EIF_TYPED_VALUE F43_887 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F43_888 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F43_889 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(808, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 864, 0x04000000, 1); /* internal_overflowed */
	*(EIF_BOOLEAN *)(Current + RTWA(864, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
...
void F43_890 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 42, Current, 8, 2, 972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 972);
	RTCC(arg1, 42, l_feature_name, 1, eif_new_type(171, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
	...
	if (EIF_TEST(loc7)) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)) < loc4)) {
				RTHOOK(10);
				RTDBGAA(Current, dtype, 863, 0x08000000, 1); /* internal_lookahead */
				ui4_1 = (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L));
				tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2105, "item", loc2))(loc2, ui4_1x)).it_c1);
				*(EIF_CHARACTER_8 *)(Current + RTWA(863, dtype)) = (EIF_CHARACTER_8) tc1;
			} else {
				RTHOOK(11);
				RTDBGAA(Current, dtype, 863, 0x08000000, 1); /* internal_lookahead */
				*(EIF_CHARACTER_8 *)(Current + RTWA(863, dtype)) = (EIF_CHARACTER_8) (EIF_CHARACTER_8) ' ';
			}
			RTHOOK(12);
			ui4_1 = loc1;
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2105, "item", loc2))(loc2, ui4_1x)).it_c1);
...
void F43_891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 42, Current, 3, 1, 973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) (loc3 <= ((EIF_INTEGER_32) 5L))) {
		...
		switch (loc3) {
			case 0L:
				RTHOOK(4);
				tc1 = *(EIF_CHARACTER_8 *)(Current + RTWA(863, dtype));
				tc2 = *(EIF_CHARACTER_8 *)(Current + RTWA(863, dtype));
				if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'x') || (EIF_BOOLEAN)(tc2 == (EIF_CHARACTER_8) 'X'))) || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '&'))) {
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-') || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+'))) {
						...
						*(EIF_CHARACTER_8 *)tr1 = arg1;
						tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3109, "is_hexa_digit", tr1))(tr1)).it_b);
						if (tb1) {
							RTHOOK(12);
							RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
							loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
							RTHOOK(13);
							RTDBGAA(Current, dtype, 866, 0x3C000000, 1); /* part1 */
							*(EIF_NATURAL_64 *)(Current + RTWA(866, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
							RTHOOK(14);
							if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (arg1 >= (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) (arg1 <= (EIF_CHARACTER_8) '9'))) {
								RTHOOK(15);
								RTDBGAA(Current, dtype, 867, 0x3C000000, 1); /* part2 */
								ti4_1 = (EIF_INTEGER_32) (arg1);
								tu8_1 = (EIF_NATURAL_64) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
								*(EIF_NATURAL_64 *)(Current + RTWA(867, dtype)) = (EIF_NATURAL_64) tu8_1;
							} else {
								RTHOOK(16);
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current + RTWA(866, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						RTNHOOK(31,1);
						tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(866, dtype));
						uu8_1 = tu8_1;
						tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(867, dtype));
						uu8_2 = tu8_2;
						ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(808, dtype));
						ui4_1 = ti4_1;
					...
					if (tb1) {
						RTHOOK(32);
						RTDBGAA(Current, dtype, 864, 0x04000000, 1); /* internal_overflowed */
						*(EIF_BOOLEAN *)(Current + RTWA(864, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
						RTHOOK(33);
						RTDBGAA(Current, dtype, 867, 0x3C000000, 1); /* part2 */
						*(EIF_NATURAL_64 *)(Current + RTWA(867, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
						RTHOOK(34);
						RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
			...
			case 3L:
				...
				*(EIF_CHARACTER_8 *)tr1 = arg1;
				...
				if (tb1) {
					...
					tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(867, dtype));
					loc2 = (EIF_NATURAL_64) tu8_1;
					RTHOOK(55);
					RTDBGAA(Current, dtype, 866, 0x3C000000, 1); /* part1 */
					tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(866, dtype));
					tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(867, dtype));
					*(EIF_NATURAL_64 *)(Current + RTWA(866, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_NATURAL_64) (tu8_1 * (EIF_NATURAL_64) ((EIF_INTEGER_32) 16L)) + tu8_2);
					RTHOOK(56);
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (arg1 >= (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) (arg1 <= (EIF_CHARACTER_8) '9'))) {
						RTHOOK(57);
						RTDBGAA(Current, dtype, 867, 0x3C000000, 1); /* part2 */
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(864, dtype)) = (EIF_BOOLEAN) tb1;
						RTHOOK(64);
						tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(805, dtype))(Current)).it_b);
						if (tb1) {
							RTHOOK(65);
							RTDBGAA(Current, dtype, 866, 0x3C000000, 1); /* part1 */
							*(EIF_NATURAL_64 *)(Current + RTWA(866, dtype)) = (EIF_NATURAL_64) loc1;
							RTHOOK(66);
							RTDBGAA(Current, dtype, 867, 0x3C000000, 1); /* part2 */
							*(EIF_NATURAL_64 *)(Current + RTWA(867, dtype)) = (EIF_NATURAL_64) loc2;
							RTHOOK(67);
							RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
							loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
						}
...
EIF_TYPED_VALUE F43_892 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F43_893 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F43_894 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 976);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F43_895 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F43_896 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 978);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(817, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F43_897 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 979);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 979);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(817, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F43_898 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 980);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 980);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(817, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F43_899 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 981);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 981);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(817, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F43_900 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 982);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F43_901 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 983);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 983);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F43_902 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 984);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 984);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F43_903 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 985);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 985);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x38000000, 1,0); /* Result */
	tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(866, dtype));
...
EIF_TYPED_VALUE F43_904 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 986);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 986);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F43_905 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
	r.it_c1 = *(EIF_CHARACTER_8 *)(Current + RTWA(863,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F43_906 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(864,Dtype(Current)));
	return r;
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 42, Current, 0, 0, 989);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(42, Current, 989);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F43_908 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(866,Dtype(Current)));
	return r;
}


/* {HEXADECIMAL_STRING_TO_INTEGER_CONVERTER}.part2 */
EIF_TYPED_VALUE F43_909 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(867,Dtype(Current)));
	return r;
}
