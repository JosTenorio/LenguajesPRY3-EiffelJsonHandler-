...
extern void F58_1115(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F58_1115 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 57, Current, 0, 1, 1193);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1060, 0x10000000, 1); /* error_code */
