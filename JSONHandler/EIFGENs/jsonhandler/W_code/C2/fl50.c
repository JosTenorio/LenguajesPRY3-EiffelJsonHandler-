...
extern EIF_TYPED_VALUE F50_970(EIF_REFERENCE);
extern EIF_TYPED_VALUE F50_971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F50_970 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 49, Current, 0, 0, 1052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(631, 28))(Current)).it_i4);
...
RTOID (F50_971)
EIF_TYPED_VALUE F50_971 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 49, Current, 0, 0, 1053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
