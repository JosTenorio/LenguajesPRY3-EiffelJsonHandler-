...
extern void F42_873(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F42_874(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F42_875(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F42_876(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_877(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_878(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_879(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_880(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_881(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_882(EIF_REFERENCE);
extern EIF_TYPED_VALUE F42_883(EIF_REFERENCE);
...
void F42_861 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 959);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 41, Current, 0, 1, 960);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 960);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(790, dtype))(Current, ui4_1x)).it_b);
...
EIF_TYPED_VALUE F42_863 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 961);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 961);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F42_864 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 962);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 962);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
EIF_TYPED_VALUE F42_865 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 963);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 963);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F42_866 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 41, Current, 4, 1, 964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 964);
	RTCC(arg1, 41, l_feature_name, 1, eif_new_type(179, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F42_867 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 965);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(816, dtype));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(816, dtype));
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(849, dtype));
...
EIF_TYPED_VALUE F42_868 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 943);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(836, dtype))(Current)).it_b);
	Result = (EIF_BOOLEAN) tb1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_TYPED_VALUE F42_869 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 944);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 944);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(816, dtype));
...
EIF_TYPED_VALUE F42_870 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 945);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F42_871 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(847, dtype));
	if (tb1) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 845, 0x10000000, 1); /* exponent */
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(845, dtype));
		*(EIF_INTEGER_32 *)(Current + RTWA(845, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) -ti4_1;
	}
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(848, dtype));
	if (tb1) {
		RTHOOK(4);
		RTDBGAA(Current, dtype, 842, 0x20000000, 1); /* natural_part */
		tr8_2 = *(EIF_REAL_64 *)(Current + RTWA(843, dtype));
		tr8_3 = *(EIF_REAL_64 *)(Current + RTWA(844, dtype));
		(*(EIF_REAL_64 *)(Current + RTWA(842, dtype))) += (EIF_REAL_64) ((EIF_REAL_64) (tr8_2) /  (EIF_REAL_64) (tr8_3));
	}
	RTHOOK(5);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(846, dtype));
	if (tb1) {
		RTHOOK(6);
...
EIF_TYPED_VALUE F42_872 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 947);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F42_873 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 41, Current, 0, 1, 948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 948);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	*(EIF_REAL_64 *)(Current + RTWA(842, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 843, 0x20000000, 1); /* fractional_part */
	tr8_1 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
	*(EIF_REAL_64 *)(Current + RTWA(843, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 844, 0x20000000, 1); /* fractional_divider */
	tr8_1 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
	*(EIF_REAL_64 *)(Current + RTWA(844, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(8);
	RTDBGAA(Current, dtype, 845, 0x10000000, 1); /* exponent */
	*(EIF_INTEGER_32 *)(Current + RTWA(845, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(9);
	RTDBGAA(Current, dtype, 846, 0x04000000, 1); /* is_negative */
	*(EIF_BOOLEAN *)(Current + RTWA(846, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(10);
	RTDBGAA(Current, dtype, 847, 0x04000000, 1); /* has_negative_exponent */
	*(EIF_BOOLEAN *)(Current + RTWA(847, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(11);
	RTDBGAA(Current, dtype, 848, 0x04000000, 1); /* has_fractional_part */
	*(EIF_BOOLEAN *)(Current + RTWA(848, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(12);
	RTDBGAA(Current, dtype, 849, 0x04000000, 1); /* needs_digit */
	*(EIF_BOOLEAN *)(Current + RTWA(849, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(13);
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(843, dtype));
		tr8_2 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
		if ((EIF_BOOLEAN)(tr8_1 == tr8_2)) {
			RTCK;
		} else {
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(844, dtype));
		tr8_2 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
		if ((EIF_BOOLEAN)(tr8_1 == tr8_2)) {
			RTCK;
		} else {
...
void F42_874 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 41, Current, 8, 2, 949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 949);
	RTCC(arg1, 41, l_feature_name, 1, eif_new_type(171, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if (EIF_TEST(loc8)) {
			...
			for (;;) {
				...
				if (tb1) {
					...
					RTHOOK(17);
					RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
					*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
				}
				RTHOOK(18);
				RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
				loc1++;
...
void F42_875 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 41, Current, 0, 1, 950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(41, Current, 950);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(816, dtype));
	switch (ti4_1) {
		case 0L:
			...
			if (tb1) {
				RTHOOK(3);
				RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
				*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
				RTHOOK(4);
				RTDBGAA(Current, dtype, 842, 0x20000000, 1); /* natural_part */
				...
				*(EIF_REAL_64 *)(Current + RTWA(842, dtype)) = (EIF_REAL_64) tr8_1;
				...
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+')) {
					RTHOOK(6);
					RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
					*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
				} else {
					RTHOOK(7);
					if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-')) {
						RTHOOK(8);
						...
						*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
						RTHOOK(9);
						RTDBGAA(Current, dtype, 846, 0x04000000, 1); /* is_negative */
						*(EIF_BOOLEAN *)(Current + RTWA(846, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
					} else {
						RTHOOK(10);
						tb1 = '\0';
						...
						if (tb1) {
							...
							if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '.')) {
								RTHOOK(12);
								RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
								*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
								RTHOOK(13);
								RTDBGAA(Current, dtype, 849, 0x04000000, 1); /* needs_digit */
								*(EIF_BOOLEAN *)(Current + RTWA(849, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
							} else {
								RTHOOK(14);
								RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
								*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 2L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(842, dtype)) = (EIF_REAL_64) (EIF_REAL_64) ((EIF_REAL_64) ((EIF_REAL_64) (tr8_1 * (EIF_REAL_64) 10.0) + tr8_2) - tr8_3);
			} else {
				RTHOOK(24);
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '.')) {
					RTHOOK(25);
					...
					*(EIF_BOOLEAN *)(Current + RTWA(849, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
					...
					if (tb1) {
						RTHOOK(28);
						RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 8L);
					} else {
						RTHOOK(29);
						...
						if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
							RTHOOK(30);
							RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
							*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
						} else {
							RTHOOK(31);
							RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
							*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 3L:
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
				RTHOOK(34);
				RTDBGAA(Current, dtype, 848, 0x04000000, 1); /* has_fractional_part */
				*(EIF_BOOLEAN *)(Current + RTWA(848, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(35);
				RTDBGAA(Current, dtype, 843, 0x20000000, 1); /* fractional_part */
				ti4_1 = (EIF_INTEGER_32) (arg1);
				tr8_1 = (EIF_REAL_64) ((EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L)));
				*(EIF_REAL_64 *)(Current + RTWA(843, dtype)) = (EIF_REAL_64) tr8_1;
				RTHOOK(36);
				RTDBGAA(Current, dtype, 844, 0x20000000, 1); /* fractional_divider */
				*(EIF_REAL_64 *)(Current + RTWA(844, dtype)) = (EIF_REAL_64) (EIF_REAL_64) 10.0;
				RTHOOK(37);
				RTDBGAA(Current, dtype, 849, 0x04000000, 1); /* needs_digit */
				*(EIF_BOOLEAN *)(Current + RTWA(849, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			} else {
				...
				tc1 = eif_builtin_CHARACTER_8_as_lower__c1_c1(arg1);
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
					tb2 = *(EIF_BOOLEAN *)(Current + RTWA(849, dtype));
					tb1 = (EIF_BOOLEAN) !tb2;
				}
				if (tb1) {
					RTHOOK(39);
		...
		case 4L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(843, dtype)) = (EIF_REAL_64) (EIF_REAL_64) ((EIF_REAL_64) (tr8_1 * (EIF_REAL_64) 10.0) + tr8_2);
				RTHOOK(46);
				RTDBGAA(Current, dtype, 844, 0x20000000, 1); /* fractional_divider */
				(*(EIF_REAL_64 *)(Current + RTWA(844, dtype))) *= (EIF_REAL_64) 10.0;
			} else {
				RTHOOK(47);
				tc1 = eif_builtin_CHARACTER_8_as_lower__c1_c1(arg1);
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
		...
		case 5L:
			...
			if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-')) {
				RTHOOK(54);
				RTDBGAA(Current, dtype, 847, 0x04000000, 1); /* has_negative_exponent */
				*(EIF_BOOLEAN *)(Current + RTWA(847, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(55);
				RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
				*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
			} else {
				RTHOOK(56);
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+')) {
					RTHOOK(57);
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
					...
					if (tb1) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(849, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
						RTHOOK(60);
						RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
						RTHOOK(61);
						RTDBGAA(Current, dtype, 845, 0x10000000, 1); /* exponent */
						ti4_1 = (EIF_INTEGER_32) (arg1);
						*(EIF_INTEGER_32 *)(Current + RTWA(845, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
					} else {
						RTHOOK(62);
						RTDBGAA(Current, dtype, 816, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(816, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 7L:
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(845, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (ti4_1 * ((EIF_INTEGER_32) 10L)) + ti4_2) - ((EIF_INTEGER_32) 48L));
			} else {
				RTHOOK(70);
				tb1 = '\0';
				tb2 = *(EIF_BOOLEAN *)(Current + RTWA(799, dtype));
...
EIF_TYPED_VALUE F42_876 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
...
EIF_TYPED_VALUE F42_877 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
...
EIF_TYPED_VALUE F42_878 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
...
EIF_TYPED_VALUE F42_879 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F42_880 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(846,Dtype(Current)));
	return r;
}


/* {STRING_TO_REAL_CONVERTOR}.has_negative_exponent */
EIF_TYPED_VALUE F42_881 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(847,Dtype(Current)));
	return r;
}


/* {STRING_TO_REAL_CONVERTOR}.has_fractional_part */
EIF_TYPED_VALUE F42_882 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(848,Dtype(Current)));
	return r;
}


/* {STRING_TO_REAL_CONVERTOR}.needs_digit */
EIF_TYPED_VALUE F42_883 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(849,Dtype(Current)));
	return r;
}
