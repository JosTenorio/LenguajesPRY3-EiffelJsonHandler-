...
extern EIF_TYPED_VALUE F208_1916(EIF_REFERENCE);
...
EIF_TYPED_VALUE F208_1916 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 207, Current, 0, 0, 2011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(207, Current, 2011);
	RTIV(Current, RTAL);
