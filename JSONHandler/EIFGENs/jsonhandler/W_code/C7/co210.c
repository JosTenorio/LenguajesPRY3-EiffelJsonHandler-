...
extern EIF_TYPED_VALUE F210_1944(EIF_REFERENCE);
extern EIF_TYPED_VALUE F210_1945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F210_1946(EIF_REFERENCE);
extern void F210_1947(EIF_REFERENCE);
extern void F210_1948(EIF_REFERENCE);
extern EIF_TYPED_VALUE F210_1950(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F210_1944 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 209, Current, 0, 0, 2689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F210_1945 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F210_1946 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 209, Current, 0, 0, 2691);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F210_1947 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 209, Current, 0, 0, 2692);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(209, Current, 2692);
	RTIV(Current, RTAL);
...
void F210_1948 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 209, Current, 0, 0, 2693);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F210_1950 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 209, Current, 2, 1, 2694);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
