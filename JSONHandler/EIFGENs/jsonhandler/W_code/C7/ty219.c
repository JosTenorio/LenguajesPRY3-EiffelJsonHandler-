...
extern EIF_TYPED_VALUE F219_1823(EIF_REFERENCE);
...
EIF_TYPED_VALUE F219_1823 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 218, Current, 0, 0, 1916);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(218, Current, 1916);
	RTIV(Current, RTAL);
