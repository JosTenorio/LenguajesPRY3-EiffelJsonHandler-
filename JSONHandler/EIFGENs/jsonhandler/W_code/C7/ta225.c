...
extern void F225_2102(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F225_2102 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 224, Current, 0, 1, 3263);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(224, Current, 3263);
	RTCC(arg1, 224, l_feature_name, 1, RTWCT(1743, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
