...
extern void F220_2010(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F220_2011(EIF_REFERENCE);
extern EIF_TYPED_VALUE F220_2012(EIF_REFERENCE);
extern EIF_TYPED_VALUE F220_2013(EIF_REFERENCE);
...
void F220_2010 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 219, Current, 0, 1, 3388);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(219, Current, 3388);
	RTCC(arg1, 219, l_feature_name, 1, RTWCT(1787, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1787, 0xF80000DA, 0); /* target */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(1787, dtype)) = (EIF_REFERENCE) arg1;
	RTHOOK(3);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(1790, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2101, "upper", arg1))(arg1)).it_i4);
		if ((EIF_BOOLEAN)(ti4_1 == ti4_2)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F220_2011 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F220_2012 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 219, Current, 0, 0, 3390);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(219, Current, 3390);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F220_2013 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
