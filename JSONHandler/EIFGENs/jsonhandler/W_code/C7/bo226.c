...
extern EIF_TYPED_VALUE F226_2079(EIF_REFERENCE);
extern void F226_4885(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F226_2079 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 225, Current, 0, 0, 3809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(225, Current, 3809);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F226_4885 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 225, Current, 0, 4884);
	RTSA(dtype);
	RTME(dtype, 0);
