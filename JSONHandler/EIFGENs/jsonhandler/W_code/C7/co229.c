...
extern EIF_TYPED_VALUE F229_1944(EIF_REFERENCE);
extern EIF_TYPED_VALUE F229_1945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F229_1946(EIF_REFERENCE);
extern void F229_1947(EIF_REFERENCE);
extern void F229_1948(EIF_REFERENCE);
extern EIF_TYPED_VALUE F229_1950(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F229_1944 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 228, Current, 0, 0, 2695);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(228, Current, 2695);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F229_1945 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F229_1946 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 228, Current, 0, 0, 2697);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(228, Current, 2697);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F229_1947 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 228, Current, 0, 0, 2698);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(228, Current, 2698);
	RTIV(Current, RTAL);
...
void F229_1948 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 228, Current, 0, 0, 2699);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(228, Current, 2699);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F229_1950 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 228, Current, 2, 1, 2700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(228, Current, 2700);
	{
		...
		RTCC(arg1, 228, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc1 = RTCCL(arg1);
