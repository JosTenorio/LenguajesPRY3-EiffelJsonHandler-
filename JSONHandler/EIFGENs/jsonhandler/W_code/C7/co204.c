...
extern EIF_TYPED_VALUE F204_2038(EIF_REFERENCE);
extern EIF_TYPED_VALUE F204_2039(EIF_REFERENCE);
extern EIF_TYPED_VALUE F204_2040(EIF_REFERENCE);
extern void F204_2041(EIF_REFERENCE);
extern void F204_2042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F204_2044(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F204_2038 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 203, Current, 0, 0, 3458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(203, Current, 3458);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F204_2039 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F204_2040 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 203, Current, 0, 0, 3460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(203, Current, 3460);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F204_2041 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 203, Current, 0, 0, 3461);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(203, Current, 3461);
	RTIV(Current, RTAL);
...
void F204_2042 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 203, Current, 0, 0, 3462);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(203, Current, 3462);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F204_2044 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 203, Current, 2, 1, 3463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(203, Current, 3463);
	{
		...
		RTCC(arg1, 203, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc1 = RTCCL(arg1);
	...
	if (EIF_TEST(loc1)) {
		...
		loc2 = RTCCL(arg1);
		{
			EIF_TYPE_INDEX typarr0[] = {0xFF01,194,0,0,0xFFFF};
			EIF_TYPE typres0;
			{
				EIF_TYPE l_type;
				l_type = RTWCT(1728, dtype, dftype);
