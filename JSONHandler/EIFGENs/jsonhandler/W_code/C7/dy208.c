...
extern void F208_2657(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F208_2659(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F208_2660(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F208_2664(EIF_REFERENCE);
...
void F208_2657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 207, Current, 1, 1, 4966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(207, Current, 4966);
	RTCC(arg1, 207, l_feature_name, 1, RTWCT(1896, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 207, Current, 0, 1, 4967);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(207, Current, 4967);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr5 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr5);
...
void F208_2660 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 207, Current, 0, 1, 4968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr4 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr4);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2193, dtype))(Current, ur1x);
		RTHOOK(8);
...
void F208_2664 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 207, Current, 0, 0, 4969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
