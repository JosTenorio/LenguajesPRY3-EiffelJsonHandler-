...
extern EIF_TYPED_VALUE F744_1830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F744_1830 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 743, Current, 0, 0, 1933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(743, Current, 1933);
	RTIV(Current, RTAL);
