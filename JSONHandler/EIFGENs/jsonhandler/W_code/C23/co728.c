...
extern EIF_TYPED_VALUE F728_2038(EIF_REFERENCE);
extern EIF_TYPED_VALUE F728_2039(EIF_REFERENCE);
extern EIF_TYPED_VALUE F728_2040(EIF_REFERENCE);
extern void F728_2041(EIF_REFERENCE);
extern void F728_2042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F728_2044(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F728_2038 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 727, Current, 0, 0, 3524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(727, Current, 3524);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F728_2039 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F728_2040 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 727, Current, 0, 0, 3526);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(727, Current, 3526);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F728_2041 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 727, Current, 0, 0, 3527);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(727, Current, 3527);
	RTIV(Current, RTAL);
...
void F728_2042 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 727, Current, 0, 0, 3528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(727, Current, 3528);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F728_2044 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 727, Current, 2, 1, 3529);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(727, Current, 3529);
	{
		...
		RTCC(arg1, 727, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc1 = RTCCL(arg1);
