...
extern EIF_TYPED_VALUE F751_1944(EIF_REFERENCE);
extern EIF_TYPED_VALUE F751_1945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F751_1946(EIF_REFERENCE);
extern void F751_1947(EIF_REFERENCE);
extern void F751_1948(EIF_REFERENCE);
extern EIF_TYPED_VALUE F751_1950(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F751_1944 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 750, Current, 0, 0, 2755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(750, Current, 2755);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F751_1945 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F751_1946 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 750, Current, 0, 0, 2757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(750, Current, 2757);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F751_1947 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 750, Current, 0, 0, 2758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(750, Current, 2758);
	RTIV(Current, RTAL);
...
void F751_1948 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 750, Current, 0, 0, 2759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(750, Current, 2759);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F751_1950 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 750, Current, 2, 1, 2760);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(750, Current, 2760);
	{
