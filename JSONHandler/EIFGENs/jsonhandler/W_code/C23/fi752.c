...
extern EIF_TYPED_VALUE F752_1983(EIF_REFERENCE);
extern void F752_5056(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F752_1983 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 751, Current, 0, 0, 3039);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(751, Current, 3039);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F752_5056 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 751, Current, 0, 5055);
	RTSA(dtype);
	RTME(dtype, 0);
