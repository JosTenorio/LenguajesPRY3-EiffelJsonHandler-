...
extern EIF_TYPED_VALUE F753_2073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F753_2074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F753_2075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F753_2076(EIF_REFERENCE);
extern void F753_2077(EIF_REFERENCE);
extern void F753_5146(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F753_2073 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F753_2074 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F753_2075 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 752, Current, 0, 0, 3223);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(752, Current, 3223);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F753_2076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 752, Current, 0, 0, 3224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(752, Current, 3224);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F753_2077 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 752, Current, 0, 0, 3219);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(752, Current, 3219);
	RTIV(Current, RTAL);
...
void F753_5146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 752, Current, 0, 5145);
	RTSA(dtype);
	RTME(dtype, 0);
