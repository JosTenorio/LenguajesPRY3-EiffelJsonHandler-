...
extern EIF_TYPED_VALUE F755_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F755_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 754, Current, 0, 0, 2023);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(754, Current, 2023);
	RTIV(Current, RTAL);
