...
extern EIF_TYPED_VALUE F757_669(EIF_REFERENCE);
extern void F757_670(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F757_671(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F757_669 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F757_670 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 756, Current, 0, 1, 761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(756, Current, 761);
	RTCC(arg1, 756, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 659, 0xF80002F4, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F757_671 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 756, Current, 0, 0, 762);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(756, Current, 762);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 659, 0xF80002F4, 0); /* right */
