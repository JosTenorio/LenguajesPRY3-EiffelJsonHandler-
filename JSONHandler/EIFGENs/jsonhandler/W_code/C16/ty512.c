...
extern EIF_TYPED_VALUE F512_1916(EIF_REFERENCE);
...
EIF_TYPED_VALUE F512_1916 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 511, Current, 0, 0, 2019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(511, Current, 2019);
	RTIV(Current, RTAL);
