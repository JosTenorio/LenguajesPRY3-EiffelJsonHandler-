...
extern EIF_TYPED_VALUE F498_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F498_2420(EIF_REFERENCE);
extern void F498_5064(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F498_2417 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 497, Current, 0, 0, 3700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(497, Current, 3700);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F498_2420 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 497, Current, 0, 0, 3698);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(497, Current, 3698);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F498_5064 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 497, Current, 0, 5063);
	RTSA(dtype);
	RTME(dtype, 0);
