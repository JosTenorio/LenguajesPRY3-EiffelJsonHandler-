...
extern EIF_TYPED_VALUE F521_2087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F521_2088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F521_2089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F521_2090(EIF_REFERENCE);
extern void F521_2091(EIF_REFERENCE);
extern void F521_4892(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F521_2087 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F521_2088 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F521_2089 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 520, Current, 0, 0, 3883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(520, Current, 3883);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F521_2090 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 520, Current, 0, 0, 3884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(520, Current, 3884);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F521_2091 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 520, Current, 0, 0, 3885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(520, Current, 3885);
	RTIV(Current, RTAL);
...
void F521_4892 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 520, Current, 0, 4891);
	RTSA(dtype);
	RTME(dtype, 0);
