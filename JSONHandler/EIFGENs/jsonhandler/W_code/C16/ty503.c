...
extern EIF_TYPED_VALUE F503_1830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F503_1830 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 502, Current, 0, 0, 1930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(502, Current, 1930);
	RTIV(Current, RTAL);
