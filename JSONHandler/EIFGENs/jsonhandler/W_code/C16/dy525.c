...
extern void F525_2713(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F525_2715(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F525_2716(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F525_2720(EIF_REFERENCE);
...
void F525_2713 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 524, Current, 1, 1, 6277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 6277);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2216, dtype))(Current, ub1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			ub1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2218, dtype))(Current, ub1x);
			RTHOOK(8);
...
void F525_2715 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 524, Current, 0, 1, 6278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 6278);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1880, "item", arg1))(arg1)).it_b);
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2217, dtype))(Current, ub1x);
		RTHOOK(8);
...
void F525_2716 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 524, Current, 0, 1, 6279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 6279);
	RTCC(arg1, 524, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F525_2720 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 524, Current, 0, 0, 6280);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 6280);
	RTIV(Current, RTAL);
	RTHOOK(1);
