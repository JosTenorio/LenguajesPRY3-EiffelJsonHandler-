...
extern EIF_TYPED_VALUE F495_2107(EIF_REFERENCE);
...
EIF_TYPED_VALUE F495_2107 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 494, Current, 0, 0, 3947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(494, Current, 3947);
	RTIV(Current, RTAL);
	RTHOOK(1);
