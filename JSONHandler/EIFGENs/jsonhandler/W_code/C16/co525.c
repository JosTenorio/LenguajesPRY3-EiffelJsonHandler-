...
extern EIF_TYPED_VALUE F525_2083(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F525_2086(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F525_2088(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F525_2083 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 524, Current, 0, 1, 3250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 3250);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F525_2086 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 524, Current, 1, 1, 3251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 3251);
	{
...
void F525_2088 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 524, Current, 0, 1, 3252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 3252);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
