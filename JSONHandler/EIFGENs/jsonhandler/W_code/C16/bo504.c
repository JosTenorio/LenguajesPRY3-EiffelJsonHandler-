...
extern EIF_TYPED_VALUE F504_2072(EIF_REFERENCE);
extern void F504_5148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F504_2072 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 503, Current, 0, 0, 3145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(503, Current, 3145);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F504_5148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 503, Current, 0, 5147);
	RTSA(dtype);
	RTME(dtype, 0);
