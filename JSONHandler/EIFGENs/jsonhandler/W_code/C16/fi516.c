...
extern EIF_TYPED_VALUE F516_2077(EIF_REFERENCE);
extern void F516_4884(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F516_2077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 515, Current, 0, 0, 3801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 3801);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F516_4884 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 515, Current, 0, 4883);
	RTSA(dtype);
	RTME(dtype, 0);
