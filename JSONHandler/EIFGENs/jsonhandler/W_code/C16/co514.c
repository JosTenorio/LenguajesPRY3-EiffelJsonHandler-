...
extern EIF_TYPED_VALUE F514_2033(EIF_REFERENCE);
extern EIF_TYPED_VALUE F514_2034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F514_2035(EIF_REFERENCE);
extern void F514_2036(EIF_REFERENCE);
extern void F514_2037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F514_2039(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F514_2033 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 513, Current, 0, 0, 2829);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(513, Current, 2829);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F514_2034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F514_2035 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 513, Current, 0, 0, 2831);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(513, Current, 2831);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F514_2036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 513, Current, 0, 0, 2832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(513, Current, 2832);
	RTIV(Current, RTAL);
...
void F514_2037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 513, Current, 0, 0, 2833);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(513, Current, 2833);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F514_2039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 513, Current, 2, 1, 2834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(513, Current, 2834);
	{
