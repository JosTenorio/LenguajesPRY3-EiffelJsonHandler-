...
extern void F503_5051(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F503_1976 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 502, Current, 0, 0, 3026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(502, Current, 3026);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F503_5051 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 502, Current, 0, 5050);
	RTSA(dtype);
	RTME(dtype, 0);
