...
extern EIF_TYPED_VALUE F501_1980(EIF_REFERENCE);
extern EIF_TYPED_VALUE F501_1981(EIF_REFERENCE);
extern EIF_TYPED_VALUE F501_1982(EIF_REFERENCE);
extern EIF_TYPED_VALUE F501_1983(EIF_REFERENCE);
extern void F501_1984(EIF_REFERENCE);
extern void F501_5053(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F501_1980 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F501_1981 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F501_1982 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 500, Current, 0, 0, 3104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(500, Current, 3104);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F501_1983 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 500, Current, 0, 0, 3105);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(500, Current, 3105);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F501_1984 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 500, Current, 0, 0, 3100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(500, Current, 3100);
	RTIV(Current, RTAL);
...
void F501_5053 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 500, Current, 0, 5052);
	RTSA(dtype);
	RTME(dtype, 0);
