...
extern EIF_TYPED_VALUE F694_2653(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F694_2654(EIF_REFERENCE);
extern EIF_TYPED_VALUE F694_2655(EIF_REFERENCE);
extern void F694_5159(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F694_2653 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 693, Current, 2, 1, 4959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 4959);
	RTCC(arg1, 693, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_b);
...
/* {LIST}.after */
EIF_TYPED_VALUE F694_2654 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 693, Current, 0, 0, 4960);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 4960);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F694_2655 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 693, Current, 0, 0, 4961);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 4961);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1858, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F694_5159 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 693, Current, 0, 5158);
	RTSA(dtype);
	RTME(dtype, 0);
