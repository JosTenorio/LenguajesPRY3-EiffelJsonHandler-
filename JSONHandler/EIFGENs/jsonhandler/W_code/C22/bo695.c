...
extern EIF_TYPED_VALUE F695_2079(EIF_REFERENCE);
extern void F695_4885(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F695_2079 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 694, Current, 0, 0, 3829);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(694, Current, 3829);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F695_4885 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 694, Current, 0, 4884);
	RTSA(dtype);
	RTME(dtype, 0);
