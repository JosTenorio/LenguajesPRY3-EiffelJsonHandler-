...
extern EIF_TYPED_VALUE F698_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F698_2420(EIF_REFERENCE);
extern void F698_5064(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F698_2417 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 3706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 3706);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80002BA, 0,0); /* Result */
	{
...
EIF_TYPED_VALUE F698_2420 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 3704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 3704);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F698_5064 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 697, Current, 0, 5063);
	RTSA(dtype);
	RTME(dtype, 0);
