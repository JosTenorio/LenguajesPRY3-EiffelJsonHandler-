...
extern EIF_TYPED_VALUE F717_1926(EIF_REFERENCE);
...
EIF_TYPED_VALUE F717_1926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 716, Current, 0, 0, 2703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(716, Current, 2703);
	RTIV(Current, RTAL);
