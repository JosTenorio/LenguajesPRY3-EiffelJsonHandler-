...
extern void F693_2657(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F693_2659(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F693_2660(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F693_2664(EIF_REFERENCE);
...
void F693_2657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 692, Current, 1, 1, 5006);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 5006);
	RTIV(Current, RTAL);
...
void F693_2659 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 692, Current, 0, 1, 5007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 5007);
	RTCC(arg1, 692, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_b);
		ub1 = tb2;
...
void F693_2660 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 692, Current, 0, 1, 5008);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 5008);
	RTCC(arg1, 692, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F693_2664 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 692, Current, 0, 0, 5009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 5009);
	RTIV(Current, RTAL);
	RTHOOK(1);
