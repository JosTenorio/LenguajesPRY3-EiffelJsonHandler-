...
extern EIF_TYPED_VALUE F717_2069(EIF_REFERENCE);
extern void F717_5144(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F717_2069 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 716, Current, 0, 0, 3125);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(716, Current, 3125);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F717_5144 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 716, Current, 0, 5143);
	RTSA(dtype);
	RTME(dtype, 0);
