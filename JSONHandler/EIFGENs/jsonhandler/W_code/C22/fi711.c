...
extern EIF_TYPED_VALUE F711_1983(EIF_REFERENCE);
extern void F711_5056(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F711_1983 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 710, Current, 0, 0, 3037);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(710, Current, 3037);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F711_5056 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 710, Current, 0, 5055);
	RTSA(dtype);
	RTME(dtype, 0);
