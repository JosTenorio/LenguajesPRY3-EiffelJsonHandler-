...
extern EIF_TYPED_VALUE F725_1931(EIF_REFERENCE);
...
EIF_TYPED_VALUE F725_1931 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 724, Current, 0, 0, 2708);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(724, Current, 2708);
	RTIV(Current, RTAL);
