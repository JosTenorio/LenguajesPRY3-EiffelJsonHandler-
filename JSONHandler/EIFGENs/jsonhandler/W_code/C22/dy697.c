...
extern void F697_2713(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F697_2715(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F697_2716(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F697_2720(EIF_REFERENCE);
...
void F697_2713 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 696, Current, 1, 1, 6285);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		ur4_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2216, dtype))(Current, ur4_1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			ur4_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2218, dtype))(Current, ur4_1x);
			RTHOOK(8);
...
void F697_2715 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1880, "item", arg1))(arg1)).it_r4);
		ur4_1 = tr4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2217, dtype))(Current, ur4_1x);
		RTHOOK(8);
...
void F697_2716 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F697_2720 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 696, Current, 0, 0, 6288);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
