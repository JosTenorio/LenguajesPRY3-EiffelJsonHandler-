...
extern EIF_TYPED_VALUE F243_2511(EIF_REFERENCE);
extern EIF_TYPED_VALUE F243_2514(EIF_REFERENCE);
extern void F243_4892(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F243_2511 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 242, Current, 0, 0, 4446);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(242, Current, 4446);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F243_2514 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 242, Current, 0, 0, 4447);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(242, Current, 4447);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2101, dtype))(Current)).it_i4);
		if ((EIF_BOOLEAN) (ti4_1 <= ti4_2)) {
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2162, "lower", Result));
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2100, dtype))(Current)).it_i4);
		...
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2101, dtype))(Current)).it_i4);
		if ((EIF_BOOLEAN) (ti4_1 <= ti4_2)) {
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2161, "upper", Result));
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2101, dtype))(Current)).it_i4);
			tb1 = (EIF_BOOLEAN)(ti4_1 == ti4_2);
		}
		if (tb1) {
...
void F243_4892 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 242, Current, 0, 4891);
	RTSA(dtype);
	RTME(dtype, 0);
