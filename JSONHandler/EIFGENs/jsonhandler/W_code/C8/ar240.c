...
extern void F240_1977(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F240_1977 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 239, Current, 0, 1, 2552);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(239, Current, 2552);
	RTCC(arg1, 239, l_feature_name, 1, RTWCT(1806, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1806, 0xF80000C9, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 239, Current, 0, 0, 2555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
