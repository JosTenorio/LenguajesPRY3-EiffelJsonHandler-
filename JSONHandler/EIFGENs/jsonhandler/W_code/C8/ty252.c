...
extern EIF_TYPED_VALUE F252_3193(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F252_3200(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F252_3206(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F252_3213(EIF_REFERENCE, EIF_TYPED_VALUE);
...
static EIF_TYPED_VALUE F252_3219_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F252_3219(EIF_REFERENCE);
extern EIF_TYPED_VALUE F252_3220(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 251, Current, 2, 0, 8334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F252_3193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 251, Current, 0, 1, 8335);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F252_3194 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 251, Current, 0, 0, 8336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(251, Current, 8336);
	RTIV(Current, RTAL);
...
/* {TYPE}.is_attached */
EIF_TYPED_VALUE F252_3200 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 251, Current, 0, 0, 8312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 251, Current, 1, 1, 8317);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	tr1 = RTCCL(arg1);
	RTOB(*(EIF_BOOLEAN *), RTWCT(2575, dtype, Dftype(Current)), tr1, loc1, tb1);
	if (tb1) {
		RTHOOK(2);
		RTDBGAL(0, 0x04000000, 0,0); /* Result */
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_BOOLEAN *)tr1 = Result;
		if (!RTEQ(tr1, arg1)) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2563, dtype))(Current)).it_b);
...
/* {TYPE}.attempt */
EIF_TYPED_VALUE F252_3206 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTDBGAL(0, 0x04000000, 0,0); /* Result */
	ur1 = RTCCL(arg1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2561, dtype))(Current, ur1x)).it_b);
	Result = (EIF_BOOLEAN) tb1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("assigned_or_void", EX_POST);
...
EIF_TYPED_VALUE F252_3208 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 251, Current, 1, 0, 8320);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 251, Current, 2, 0, 8321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 251, Current, 0, 1, 8324);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F252_3213 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 251, Current, 0, 1, 8325);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {TYPE}.internal_name */
static EIF_TYPED_VALUE F252_3219_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F252_3219 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(2573, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F252_3219_body (Current)).it_r;
...
/* {TYPE}.runtime_name */
EIF_TYPED_VALUE F252_3220 (EIF_REFERENCE Current)
{
	GTCX
