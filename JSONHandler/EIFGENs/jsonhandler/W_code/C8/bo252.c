...
extern EIF_TYPED_VALUE F252_1978(EIF_REFERENCE);
extern void F252_5052(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F252_1978 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 251, Current, 0, 0, 3034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(251, Current, 3034);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F252_5052 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 251, Current, 0, 5051);
	RTSA(dtype);
	RTME(dtype, 0);
