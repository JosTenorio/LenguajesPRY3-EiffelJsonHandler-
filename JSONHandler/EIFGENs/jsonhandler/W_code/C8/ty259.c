...
extern EIF_TYPED_VALUE F259_1916(EIF_REFERENCE);
...
EIF_TYPED_VALUE F259_1916 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 258, Current, 0, 0, 2012);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(258, Current, 2012);
	RTIV(Current, RTAL);
