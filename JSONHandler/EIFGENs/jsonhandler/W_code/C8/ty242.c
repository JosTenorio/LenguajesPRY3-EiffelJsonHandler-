...
extern EIF_TYPED_VALUE F242_3193(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F242_3200(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F242_3206(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F242_3213(EIF_REFERENCE, EIF_TYPED_VALUE);
...
static EIF_TYPED_VALUE F242_3219_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F242_3219(EIF_REFERENCE);
extern EIF_TYPED_VALUE F242_3220(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 241, Current, 2, 0, 8034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F242_3193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F242_3194 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 241, Current, 0, 0, 8036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
/* {TYPE}.is_attached */
EIF_TYPED_VALUE F242_3200 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 241, Current, 0, 0, 8012);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 241, Current, 1, 1, 8017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_REAL_64 *)tr1 = Result;
		if (!RTEQ(tr1, arg1)) {
			tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2563, dtype))(Current)).it_r8);
...
/* {TYPE}.attempt */
EIF_TYPED_VALUE F242_3206 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTDBGAL(0, 0x20000000, 0,0); /* Result */
	ur1 = RTCCL(arg1);
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2561, dtype))(Current, ur1x)).it_r8);
...
EIF_TYPED_VALUE F242_3208 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 241, Current, 1, 0, 8020);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 241, Current, 2, 0, 8021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 241, Current, 0, 1, 8024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F242_3213 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 241, Current, 0, 1, 8025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {TYPE}.internal_name */
static EIF_TYPED_VALUE F242_3219_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F242_3219 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(2573, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F242_3219_body (Current)).it_r;
...
/* {TYPE}.runtime_name */
EIF_TYPED_VALUE F242_3220 (EIF_REFERENCE Current)
{
	GTCX
