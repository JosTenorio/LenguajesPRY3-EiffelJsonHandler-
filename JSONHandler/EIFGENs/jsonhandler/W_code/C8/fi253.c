...
extern EIF_TYPED_VALUE F253_1976(EIF_REFERENCE);
extern void F253_5051(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F253_1976 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 252, Current, 0, 0, 3012);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(252, Current, 3012);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F253_5051 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 252, Current, 0, 5050);
	RTSA(dtype);
	RTME(dtype, 0);
