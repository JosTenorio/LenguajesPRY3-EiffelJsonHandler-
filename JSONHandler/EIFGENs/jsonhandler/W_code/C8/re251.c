...
extern EIF_TYPED_VALUE F251_1980(EIF_REFERENCE);
extern EIF_TYPED_VALUE F251_1981(EIF_REFERENCE);
extern EIF_TYPED_VALUE F251_1982(EIF_REFERENCE);
extern EIF_TYPED_VALUE F251_1983(EIF_REFERENCE);
extern void F251_1984(EIF_REFERENCE);
extern void F251_5053(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F251_1980 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F251_1981 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F251_1982 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 250, Current, 0, 0, 3062);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(250, Current, 3062);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F251_1983 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 250, Current, 0, 0, 3063);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(250, Current, 3063);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F251_1984 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 250, Current, 0, 0, 3058);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(250, Current, 3058);
	RTIV(Current, RTAL);
...
void F251_5053 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 250, Current, 0, 5052);
	RTSA(dtype);
	RTME(dtype, 0);
