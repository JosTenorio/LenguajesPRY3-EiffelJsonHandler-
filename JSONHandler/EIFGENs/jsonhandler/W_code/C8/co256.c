...
extern EIF_TYPED_VALUE F256_2038(EIF_REFERENCE);
extern EIF_TYPED_VALUE F256_2039(EIF_REFERENCE);
extern EIF_TYPED_VALUE F256_2040(EIF_REFERENCE);
extern void F256_2041(EIF_REFERENCE);
extern void F256_2042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F256_2044(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F256_2038 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 255, Current, 0, 0, 3464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(255, Current, 3464);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F256_2039 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F256_2040 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 255, Current, 0, 0, 3466);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(255, Current, 3466);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F256_2041 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 255, Current, 0, 0, 3467);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(255, Current, 3467);
	RTIV(Current, RTAL);
...
void F256_2042 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 255, Current, 0, 0, 3468);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(255, Current, 3468);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F256_2044 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 255, Current, 2, 1, 3469);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(255, Current, 3469);
	{
