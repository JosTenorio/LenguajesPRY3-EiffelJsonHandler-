...
extern EIF_TYPED_VALUE F481_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F481_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 480, Current, 0, 0, 2019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(480, Current, 2019);
	RTIV(Current, RTAL);
