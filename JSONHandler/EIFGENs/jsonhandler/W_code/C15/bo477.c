...
extern EIF_TYPED_VALUE F477_1978(EIF_REFERENCE);
extern void F477_5052(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F477_1978 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 476, Current, 0, 0, 3046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(476, Current, 3046);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F477_5052 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 476, Current, 0, 5051);
	RTSA(dtype);
	RTME(dtype, 0);
