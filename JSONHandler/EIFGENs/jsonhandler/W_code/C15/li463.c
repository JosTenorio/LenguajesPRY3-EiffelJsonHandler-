...
extern EIF_TYPED_VALUE F463_2566(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F463_2567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F463_2568(EIF_REFERENCE);
extern void F463_5068(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F463_2566 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 462, Current, 2, 1, 4849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 4849);
...
/* {LIST}.after */
EIF_TYPED_VALUE F463_2567 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 462, Current, 0, 0, 4850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 4850);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F463_2568 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 462, Current, 0, 0, 4851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 4851);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1774, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F463_5068 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 462, Current, 0, 5067);
	RTSA(dtype);
	RTME(dtype, 0);
