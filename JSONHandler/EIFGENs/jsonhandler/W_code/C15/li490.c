...
extern EIF_TYPED_VALUE F490_2709(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F490_2710(EIF_REFERENCE);
extern EIF_TYPED_VALUE F490_2711(EIF_REFERENCE);
extern void F490_4897(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F490_2709 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 489, Current, 2, 1, 6225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 6225);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1880, "item", arg1))(arg1)).it_i4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F490_2710 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 489, Current, 0, 0, 6226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 6226);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F490_2711 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 489, Current, 0, 0, 6227);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 6227);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1842, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F490_4897 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 489, Current, 0, 4896);
	RTSA(dtype);
	RTME(dtype, 0);
