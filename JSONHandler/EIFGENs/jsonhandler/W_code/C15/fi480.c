...
extern EIF_TYPED_VALUE F480_2077(EIF_REFERENCE);
extern void F480_4884(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F480_2077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 479, Current, 0, 0, 3799);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(479, Current, 3799);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F480_4884 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 479, Current, 0, 4883);
	RTSA(dtype);
	RTME(dtype, 0);
