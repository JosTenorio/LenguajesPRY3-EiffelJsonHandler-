...
extern void F481_2570(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F481_2572(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F481_2573(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F481_2577(EIF_REFERENCE);
...
void F481_2570 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 480, Current, 1, 1, 4902);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(480, Current, 4902);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uc1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2107, dtype))(Current, uc1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uc1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2109, dtype))(Current, uc1x);
			RTHOOK(8);
...
void F481_2572 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 480, Current, 0, 1, 4903);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(480, Current, 4903);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1812, "item", arg1))(arg1)).it_c1);
		uc1 = tc1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2108, dtype))(Current, uc1x);
		RTHOOK(8);
...
void F481_2573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 480, Current, 0, 1, 4900);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(480, Current, 4900);
	RTCC(arg1, 480, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F481_2577 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 480, Current, 0, 0, 4901);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(480, Current, 4901);
	RTIV(Current, RTAL);
	RTHOOK(1);
