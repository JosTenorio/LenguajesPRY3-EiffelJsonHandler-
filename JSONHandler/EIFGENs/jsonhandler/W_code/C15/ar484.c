...
extern void F484_1980(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F484_1981(EIF_REFERENCE);
extern EIF_TYPED_VALUE F484_1982(EIF_REFERENCE);
extern EIF_TYPED_VALUE F484_1983(EIF_REFERENCE);
extern EIF_TYPED_VALUE F484_1984(EIF_REFERENCE);
extern EIF_TYPED_VALUE F484_1985(EIF_REFERENCE);
...
void F484_1980 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 483, Current, 0, 1, 2593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 2593);
	RTCC(arg1, 483, l_feature_name, 1, RTWCT(1809, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1809, 0xF80001DA, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1809, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1804, 0xF80001CA, 0); /* area */
...
EIF_TYPED_VALUE F484_1981 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F484_1982 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 483, Current, 0, 0, 2595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 2595);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F484_1983 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 483, Current, 0, 0, 2596);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 2596);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1787, 451))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F484_1984 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F484_1985 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
