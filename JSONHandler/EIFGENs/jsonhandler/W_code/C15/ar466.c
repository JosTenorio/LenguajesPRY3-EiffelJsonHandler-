...
extern void F466_2004(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F466_2005(EIF_REFERENCE);
extern EIF_TYPED_VALUE F466_2006(EIF_REFERENCE);
extern EIF_TYPED_VALUE F466_2007(EIF_REFERENCE);
extern EIF_TYPED_VALUE F466_2008(EIF_REFERENCE);
extern EIF_TYPED_VALUE F466_2009(EIF_REFERENCE);
...
void F466_2004 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 465, Current, 0, 1, 3358);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(465, Current, 3358);
	RTCC(arg1, 465, l_feature_name, 1, RTWCT(1800, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1800, 0xF80001D0, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 465, Current, 0, 0, 3360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(465, Current, 3360);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F466_2007 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 465, Current, 0, 0, 3361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(465, Current, 3361);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F466_2008 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F466_2009 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
