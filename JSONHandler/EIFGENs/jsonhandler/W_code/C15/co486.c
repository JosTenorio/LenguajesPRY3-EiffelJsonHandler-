...
extern EIF_TYPED_VALUE F486_2033(EIF_REFERENCE);
extern EIF_TYPED_VALUE F486_2034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F486_2035(EIF_REFERENCE);
extern void F486_2036(EIF_REFERENCE);
extern void F486_2037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F486_2039(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F486_2033 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 485, Current, 0, 0, 2823);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 2823);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F486_2034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F486_2035 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 485, Current, 0, 0, 2825);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 2825);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F486_2036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 485, Current, 0, 0, 2826);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 2826);
	RTIV(Current, RTAL);
...
void F486_2037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 485, Current, 0, 0, 2827);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 2827);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F486_2039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 485, Current, 2, 1, 2828);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 2828);
	{
		...
		RTCC(arg1, 485, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc1 = RTCCL(arg1);
