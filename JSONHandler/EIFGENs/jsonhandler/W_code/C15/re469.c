...
extern EIF_TYPED_VALUE F469_2511(EIF_REFERENCE);
extern EIF_TYPED_VALUE F469_2514(EIF_REFERENCE);
extern void F469_4892(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F469_2511 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 468, Current, 0, 0, 4464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(468, Current, 4464);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F469_2514 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 468, Current, 0, 0, 4465);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(468, Current, 4465);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F469_4892 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 468, Current, 0, 4891);
	RTSA(dtype);
	RTME(dtype, 0);
