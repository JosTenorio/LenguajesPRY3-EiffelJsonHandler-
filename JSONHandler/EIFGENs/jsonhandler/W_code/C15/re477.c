...
extern EIF_TYPED_VALUE F477_2504(EIF_REFERENCE);
extern EIF_TYPED_VALUE F477_2507(EIF_REFERENCE);
extern void F477_5155(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F477_2504 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 476, Current, 0, 0, 3786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(476, Current, 3786);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F477_2507 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 476, Current, 0, 0, 3787);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(476, Current, 3787);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F477_5155 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 476, Current, 0, 5154);
	RTSA(dtype);
	RTME(dtype, 0);
