...
extern void F303_2657(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F303_2659(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F303_2660(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F303_2664(EIF_REFERENCE);
...
void F303_2657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 302, Current, 1, 1, 4974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 4974);
	RTIV(Current, RTAL);
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 302, Current, 0, 1, 4975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 4975);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_c1);
		uc1 = tc1;
...
void F303_2660 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 302, Current, 0, 1, 4976);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F303_2664 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 302, Current, 0, 0, 4977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
