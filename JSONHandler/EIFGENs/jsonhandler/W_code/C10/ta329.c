...
extern void F329_2105(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F329_2105 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 328, Current, 0, 1, 3269);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(328, Current, 3269);
	RTCC(arg1, 328, l_feature_name, 1, RTWCT(1746, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
