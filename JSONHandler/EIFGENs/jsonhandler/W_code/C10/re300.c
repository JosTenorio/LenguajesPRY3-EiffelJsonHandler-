...
extern EIF_TYPED_VALUE F300_2087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F300_2088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F300_2089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F300_2090(EIF_REFERENCE);
extern void F300_2091(EIF_REFERENCE);
extern void F300_4892(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F300_2087 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F300_2088 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F300_2089 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 299, Current, 0, 0, 3841);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(299, Current, 3841);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F300_2090 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 299, Current, 0, 0, 3842);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(299, Current, 3842);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F300_2091 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 299, Current, 0, 0, 3843);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(299, Current, 3843);
	RTIV(Current, RTAL);
...
void F300_4892 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 299, Current, 0, 4891);
	RTSA(dtype);
	RTME(dtype, 0);
