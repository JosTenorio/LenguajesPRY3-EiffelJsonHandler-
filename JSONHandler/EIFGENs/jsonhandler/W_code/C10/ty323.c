...
extern EIF_TYPED_VALUE F323_1830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F323_1830 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 322, Current, 0, 0, 1926);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(322, Current, 1926);
	RTIV(Current, RTAL);
