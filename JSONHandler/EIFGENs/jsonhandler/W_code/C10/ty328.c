...
extern EIF_TYPED_VALUE F328_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F328_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 327, Current, 0, 0, 2015);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(327, Current, 2015);
	RTIV(Current, RTAL);
