...
extern EIF_TYPED_VALUE F298_1976(EIF_REFERENCE);
extern void F298_5051(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F298_1976 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 297, Current, 0, 0, 3014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(297, Current, 3014);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F298_5051 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 297, Current, 0, 5050);
	RTSA(dtype);
	RTME(dtype, 0);
