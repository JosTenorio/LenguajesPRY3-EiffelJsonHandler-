...
extern EIF_TYPED_VALUE F321_1931(EIF_REFERENCE);
...
EIF_TYPED_VALUE F321_1931 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 320, Current, 0, 0, 2701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(320, Current, 2701);
	RTIV(Current, RTAL);
