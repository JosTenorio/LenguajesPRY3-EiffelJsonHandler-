...
extern EIF_TYPED_VALUE F303_2014(EIF_REFERENCE);
extern void F303_5054(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F303_2014 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 302, Current, 0, 0, 3200);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 3200);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F303_5054 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 302, Current, 0, 5053);
	RTSA(dtype);
	RTME(dtype, 0);
