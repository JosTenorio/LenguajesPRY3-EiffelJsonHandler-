...
extern EIF_TYPED_VALUE F300_1962(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F300_1970(EIF_REFERENCE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 299, Current, 0, 0, 2361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(299, Current, 2361);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F300_1962 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 299, Current, 0, 1, 2367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 299, Current, 0, 0, 2372);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F300_1970 (EIF_REFERENCE Current)
{
	GTCX
