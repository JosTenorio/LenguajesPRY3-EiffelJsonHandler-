...
extern void F321_2004(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F321_2005(EIF_REFERENCE);
extern EIF_TYPED_VALUE F321_2006(EIF_REFERENCE);
extern EIF_TYPED_VALUE F321_2007(EIF_REFERENCE);
extern EIF_TYPED_VALUE F321_2008(EIF_REFERENCE);
extern EIF_TYPED_VALUE F321_2009(EIF_REFERENCE);
...
void F321_2004 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 320, Current, 0, 1, 3334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(320, Current, 3334);
	RTCC(arg1, 320, l_feature_name, 1, RTWCT(1800, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1800, 0xF800013F, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1800, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1787, 0xF8000148, 0); /* area */
...
EIF_TYPED_VALUE F321_2005 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F321_2006 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 320, Current, 0, 0, 3336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(320, Current, 3336);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000140, 0,0); /* Result */
	{
...
EIF_TYPED_VALUE F321_2007 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 320, Current, 0, 0, 3337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(320, Current, 3337);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1770, 321))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F321_2008 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F321_2009 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
