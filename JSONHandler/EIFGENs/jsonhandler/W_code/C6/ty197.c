...
extern EIF_TYPED_VALUE F197_3193(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F197_3200(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F197_3206(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F197_3213(EIF_REFERENCE, EIF_TYPED_VALUE);
...
static EIF_TYPED_VALUE F197_3219_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F197_3219(EIF_REFERENCE);
extern EIF_TYPED_VALUE F197_3220(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 196, Current, 2, 0, 7914);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F197_3193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 196, Current, 0, 1, 7915);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F197_3194 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 196, Current, 0, 0, 7916);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(196, Current, 7916);
	RTIV(Current, RTAL);
...
/* {TYPE}.is_attached */
EIF_TYPED_VALUE F197_3200 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 196, Current, 0, 0, 7892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 196, Current, 1, 1, 7897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	tr1 = RTCCL(arg1);
	RTOB(*(EIF_INTEGER_8 *), RTWCT(2575, dtype, Dftype(Current)), tr1, loc1, tb1);
	if (tb1) {
		RTHOOK(2);
		RTDBGAL(0, 0x0C000000, 0,0); /* Result */
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_INTEGER_8 *)tr1 = Result;
		if (!RTEQ(tr1, arg1)) {
			ti1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2563, dtype))(Current)).it_i1);
...
/* {TYPE}.attempt */
EIF_TYPED_VALUE F197_3206 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTDBGAL(0, 0x0C000000, 0,0); /* Result */
	ur1 = RTCCL(arg1);
	ti1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2561, dtype))(Current, ur1x)).it_i1);
...
EIF_TYPED_VALUE F197_3208 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 196, Current, 1, 0, 7900);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 196, Current, 2, 0, 7901);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 196, Current, 0, 1, 7904);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F197_3213 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 196, Current, 0, 1, 7905);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {TYPE}.internal_name */
static EIF_TYPED_VALUE F197_3219_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F197_3219 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(2573, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F197_3219_body (Current)).it_r;
...
/* {TYPE}.runtime_name */
EIF_TYPED_VALUE F197_3220 (EIF_REFERENCE Current)
{
	GTCX
