...
extern void F189_4883(EIF_REFERENCE);
extern void F189_4884(EIF_REFERENCE);
extern void F189_4885(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F189_4886(EIF_REFERENCE);
extern EIF_TYPED_VALUE F189_4887(EIF_REFERENCE);
extern EIF_TYPED_VALUE F189_4888(EIF_REFERENCE);
...
#define arg1 arg1x.it_b
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3589, 0x04000000, 1); /* item */
	*(EIF_BOOLEAN *)(Current + RTWA(3589, dtype)) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F189_4883 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 188, Current, 0, 0, 10723);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3585, dtype))(Current, ub1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F189_4884 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 188, Current, 0, 0, 10724);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {JSON_BOOLEAN}.item */
EIF_TYPED_VALUE F189_4886 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(3589,Dtype(Current)));
	return r;
}


/* {JSON_BOOLEAN}.hash_code */
EIF_TYPED_VALUE F189_4887 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 188, Current, 0, 0, 10727);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(3589, dtype));
	ti4_1 = (tb1 ? 1L : 0L);
...
EIF_TYPED_VALUE F189_4888 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 188, Current, 0, 0, 10728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 188, Current, 0, 1, 10729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(188, Current, 10729);
	RTCC(arg1, 188, l_feature_name, 1, eif_new_type(5, 0x01), 0x01);
	RTIV(Current, RTAL);
