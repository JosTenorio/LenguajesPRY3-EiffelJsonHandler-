...
extern EIF_TYPED_VALUE F192_674(EIF_REFERENCE);
extern void F192_675(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F192_676(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F192_674 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F192_675 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 191, Current, 0, 1, 763);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(191, Current, 763);
	RTCC(arg1, 191, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 664, 0xF80000BF, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F192_676 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 191, Current, 0, 0, 764);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(191, Current, 764);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 664, 0xF80000BF, 0); /* right */
