...
extern EIF_TYPED_VALUE F334_2038(EIF_REFERENCE);
extern EIF_TYPED_VALUE F334_2039(EIF_REFERENCE);
extern EIF_TYPED_VALUE F334_2040(EIF_REFERENCE);
extern void F334_2041(EIF_REFERENCE);
extern void F334_2042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F334_2044(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F334_2038 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 333, Current, 0, 0, 3476);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3476);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F334_2039 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F334_2040 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 333, Current, 0, 0, 3478);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3478);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F334_2041 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 333, Current, 0, 0, 3479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3479);
	RTIV(Current, RTAL);
...
void F334_2042 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 333, Current, 0, 0, 3480);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3480);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F334_2044 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 333, Current, 2, 1, 3481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3481);
	{
