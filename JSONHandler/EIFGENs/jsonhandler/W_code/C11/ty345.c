...
extern EIF_TYPED_VALUE F345_1916(EIF_REFERENCE);
...
EIF_TYPED_VALUE F345_1916 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 344, Current, 0, 0, 2014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(344, Current, 2014);
	RTIV(Current, RTAL);
