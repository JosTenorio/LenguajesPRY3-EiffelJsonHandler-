...
extern EIF_TYPED_VALUE F343_2070(EIF_REFERENCE);
extern void F343_5147(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F343_2070 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 342, Current, 0, 0, 3113);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(342, Current, 3113);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F343_5147 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 342, Current, 0, 5146);
	RTSA(dtype);
	RTME(dtype, 0);
