...
extern EIF_TYPED_VALUE F341_2701(EIF_REFERENCE);
extern void F341_2707(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F341_2708(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F341_2711(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F341_2712(EIF_REFERENCE);
extern EIF_TYPED_VALUE F341_2713(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F341_2701 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 340, Current, 0, 0, 6143);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(340, Current, 6143);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DYNAMIC_CHAIN}.prune */
void F341_2707 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 340, Current, 0, 1, 6144);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(340, Current, 6144);
	RTIV(Current, RTAL);
...
void F341_2708 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 340, Current, 0, 1, 6145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(340, Current, 6145);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F341_2711 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 340, Current, 3, 1, 6146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(340, Current, 6146);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1717, "item", loc3))(loc3)).it_p);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1766, "target_index", loc3))(loc3)).it_i4);
...
void F341_2712 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 340, Current, 0, 0, 6147);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(340, Current, 6147);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F341_2713 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 340, Current, 2, 1, 6148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(340, Current, 6148);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1872, "extend", Result))(Result, up1x);
		RTHOOK(9);
