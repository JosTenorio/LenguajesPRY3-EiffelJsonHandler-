...
extern void F361_1995(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F361_1996(EIF_REFERENCE);
extern EIF_TYPED_VALUE F361_1997(EIF_REFERENCE);
...
void F361_1995 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 360, Current, 0, 1, 2654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 2654);
	RTCC(arg1, 360, l_feature_name, 1, RTWCT(1814, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1814, 0xF800014F, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F361_1996 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F361_1997 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 360, Current, 0, 0, 2656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 360, Current, 0, 0, 2657);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 2657);
	RTIV(Current, RTAL);
	RTHOOK(1);
