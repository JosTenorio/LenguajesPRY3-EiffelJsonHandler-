...
extern EIF_TYPED_VALUE F353_2073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_2074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_2075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_2076(EIF_REFERENCE);
extern void F353_2077(EIF_REFERENCE);
extern void F353_5146(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F353_2073 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F353_2074 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F353_2075 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 3175);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 3175);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F353_2076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 3176);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 3176);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F353_2077 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 3171);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 3171);
	RTIV(Current, RTAL);
...
void F353_5146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 352, Current, 0, 5145);
	RTSA(dtype);
	RTME(dtype, 0);
