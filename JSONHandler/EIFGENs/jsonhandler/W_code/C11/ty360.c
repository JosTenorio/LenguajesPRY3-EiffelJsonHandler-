...
extern EIF_TYPED_VALUE F360_1926(EIF_REFERENCE);
...
EIF_TYPED_VALUE F360_1926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 2696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 2696);
	RTIV(Current, RTAL);
