...
extern EIF_TYPED_VALUE F347_1987(EIF_REFERENCE);
extern EIF_TYPED_VALUE F347_1988(EIF_REFERENCE);
extern EIF_TYPED_VALUE F347_1989(EIF_REFERENCE);
extern EIF_TYPED_VALUE F347_1990(EIF_REFERENCE);
extern void F347_1991(EIF_REFERENCE);
extern void F347_5058(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F347_1987 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F347_1988 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F347_1989 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 346, Current, 0, 0, 3072);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(346, Current, 3072);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F347_1990 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 346, Current, 0, 0, 3073);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(346, Current, 3073);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F347_1991 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 346, Current, 0, 0, 3074);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(346, Current, 3074);
	RTIV(Current, RTAL);
...
void F347_5058 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 346, Current, 0, 5057);
	RTSA(dtype);
	RTME(dtype, 0);
