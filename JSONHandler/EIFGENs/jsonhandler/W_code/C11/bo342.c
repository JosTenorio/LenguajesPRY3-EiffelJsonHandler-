...
extern EIF_TYPED_VALUE F342_2079(EIF_REFERENCE);
extern void F342_4885(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F342_2079 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 341, Current, 0, 0, 3815);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(341, Current, 3815);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F342_4885 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 341, Current, 0, 4884);
	RTSA(dtype);
	RTME(dtype, 0);
