...
extern void F360_1979(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F360_1983(EIF_REFERENCE);
extern EIF_TYPED_VALUE F360_1984(EIF_REFERENCE);
...
void F360_1979 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 359, Current, 0, 1, 2573);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 2573);
	RTCC(arg1, 359, l_feature_name, 1, RTWCT(1808, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1808, 0xF8000150, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 2575);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 2575);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 2576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 2576);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F360_1983 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F360_1984 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
