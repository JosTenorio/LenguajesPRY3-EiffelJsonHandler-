...
extern EIF_TYPED_VALUE F332_2506(EIF_REFERENCE);
extern EIF_TYPED_VALUE F332_2509(EIF_REFERENCE);
extern void F332_5157(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F332_2506 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 331, Current, 0, 0, 3776);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(331, Current, 3776);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F332_2509 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 331, Current, 0, 0, 3777);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(331, Current, 3777);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F332_5157 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 331, Current, 0, 5156);
	RTSA(dtype);
	RTME(dtype, 0);
