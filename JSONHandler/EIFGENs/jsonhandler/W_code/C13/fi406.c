...
extern EIF_TYPED_VALUE F406_2083(EIF_REFERENCE);
extern void F406_4890(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F406_2083 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 3803);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 3803);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F406_4890 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 405, Current, 0, 4889);
	RTSA(dtype);
	RTME(dtype, 0);
