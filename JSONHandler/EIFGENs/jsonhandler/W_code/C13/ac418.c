...
extern EIF_TYPED_VALUE F418_2014(EIF_REFERENCE);
extern void F418_5054(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F418_2014 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 417, Current, 0, 0, 3208);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(417, Current, 3208);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F418_5054 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 417, Current, 0, 5053);
	RTSA(dtype);
	RTME(dtype, 0);
