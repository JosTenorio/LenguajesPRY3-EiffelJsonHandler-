...
extern EIF_TYPED_VALUE F407_2038(EIF_REFERENCE);
extern EIF_TYPED_VALUE F407_2039(EIF_REFERENCE);
extern EIF_TYPED_VALUE F407_2040(EIF_REFERENCE);
extern void F407_2041(EIF_REFERENCE);
extern void F407_2042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F407_2044(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F407_2038 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 406, Current, 0, 0, 3488);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 3488);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F407_2039 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F407_2040 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 406, Current, 0, 0, 3490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 3490);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F407_2041 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 406, Current, 0, 0, 3491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 3491);
	RTIV(Current, RTAL);
...
void F407_2042 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 406, Current, 0, 0, 3492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 3492);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F407_2044 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 406, Current, 2, 1, 3493);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 3493);
	{
