...
extern EIF_TYPED_VALUE F403_1983(EIF_REFERENCE);
extern void F403_5056(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F403_1983 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 402, Current, 0, 0, 3029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(402, Current, 3029);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F403_5056 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 402, Current, 0, 5055);
	RTSA(dtype);
	RTME(dtype, 0);
