...
extern EIF_TYPED_VALUE F396_2072(EIF_REFERENCE);
extern void F396_5148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F396_2072 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 395, Current, 0, 0, 3139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(395, Current, 3139);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F396_5148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 395, Current, 0, 5147);
	RTSA(dtype);
	RTME(dtype, 0);
