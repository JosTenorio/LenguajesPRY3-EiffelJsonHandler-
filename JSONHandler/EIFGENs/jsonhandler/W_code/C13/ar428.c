...
extern void F428_1986(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F428_1987(EIF_REFERENCE);
extern EIF_TYPED_VALUE F428_1988(EIF_REFERENCE);
extern EIF_TYPED_VALUE F428_1989(EIF_REFERENCE);
extern EIF_TYPED_VALUE F428_1990(EIF_REFERENCE);
extern EIF_TYPED_VALUE F428_1991(EIF_REFERENCE);
...
void F428_1986 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 427, Current, 0, 1, 3262);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 3262);
	RTCC(arg1, 427, l_feature_name, 1, RTWCT(1792, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1792, 0xF800019F, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1792, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1787, 0xF8000191, 0); /* area */
...
EIF_TYPED_VALUE F428_1987 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F428_1988 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 427, Current, 0, 0, 3264);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 3264);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F428_1989 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 427, Current, 0, 0, 3265);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 3265);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1770, 394))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F428_1990 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F428_1991 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
