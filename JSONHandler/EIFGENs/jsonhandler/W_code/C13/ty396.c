...
extern EIF_TYPED_VALUE F396_1926(EIF_REFERENCE);
...
EIF_TYPED_VALUE F396_1926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 395, Current, 0, 0, 2697);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(395, Current, 2697);
	RTIV(Current, RTAL);
