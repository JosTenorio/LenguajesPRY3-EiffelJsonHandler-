...
extern EIF_TYPED_VALUE F409_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F409_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 408, Current, 0, 0, 2017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(408, Current, 2017);
	RTIV(Current, RTAL);
