...
extern EIF_TYPED_VALUE F415_2072(EIF_REFERENCE);
extern void F415_5149(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F415_2072 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 414, Current, 0, 0, 3119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(414, Current, 3119);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F415_5149 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 414, Current, 0, 5148);
	RTSA(dtype);
	RTME(dtype, 0);
