...
extern EIF_TYPED_VALUE F415_2079(EIF_REFERENCE);
extern void F415_4885(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F415_2079 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 414, Current, 0, 0, 3819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(414, Current, 3819);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F415_4885 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 414, Current, 0, 4884);
	RTSA(dtype);
	RTME(dtype, 0);
