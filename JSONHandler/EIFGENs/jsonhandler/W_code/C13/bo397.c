...
extern EIF_TYPED_VALUE F397_2074(EIF_REFERENCE);
extern void F397_5150(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F397_2074 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 396, Current, 0, 0, 3141);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 3141);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F397_5150 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 396, Current, 0, 5149);
	RTSA(dtype);
	RTME(dtype, 0);
