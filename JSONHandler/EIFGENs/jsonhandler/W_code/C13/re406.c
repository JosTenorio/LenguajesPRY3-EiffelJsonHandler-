...
extern EIF_TYPED_VALUE F406_2506(EIF_REFERENCE);
extern EIF_TYPED_VALUE F406_2509(EIF_REFERENCE);
extern void F406_5157(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F406_2506 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 3782);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 3782);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F406_2509 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 3783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 3783);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F406_5157 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 405, Current, 0, 5156);
	RTSA(dtype);
	RTME(dtype, 0);
