...
extern EIF_TYPED_VALUE F421_2503(EIF_REFERENCE);
extern EIF_TYPED_VALUE F421_2506(EIF_REFERENCE);
extern void F421_5152(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F421_2503 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 420, Current, 0, 0, 3779);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(420, Current, 3779);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F421_2506 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 420, Current, 0, 0, 3780);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(420, Current, 3780);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F421_5152 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 420, Current, 0, 5151);
	RTSA(dtype);
	RTME(dtype, 0);
