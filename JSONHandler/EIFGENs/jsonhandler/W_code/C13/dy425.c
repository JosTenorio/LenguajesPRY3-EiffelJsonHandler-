...
extern EIF_TYPED_VALUE F425_2639(EIF_REFERENCE);
extern void F425_2645(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F425_2646(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F425_2649(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F425_2650(EIF_REFERENCE);
...
EIF_TYPED_VALUE F425_2639 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 4876);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 4876);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 424, Current, 0, 1, 4877);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 4877);
	RTIV(Current, RTAL);
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 424, Current, 0, 1, 4878);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 4878);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F425_2649 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 424, Current, 3, 1, 4879);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 4879);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tr4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1727, "item", loc3))(loc3)).it_r4);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1775, "target_index", loc3))(loc3)).it_i4);
...
void F425_2650 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 4880);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 4880);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 424, Current, 2, 1, 4881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 4881);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAL(0, 0xF80001A8, 0,0); /* Result */
	...
	for (;;) {
		...
		ur4_1 = tr4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1882, "extend", Result))(Result, ur4_1x);
		RTHOOK(9);
