...
extern EIF_TYPED_VALUE F558_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F558_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 557, Current, 0, 0, 2021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(557, Current, 2021);
	RTIV(Current, RTAL);
