...
extern EIF_TYPED_VALUE F544_2101(EIF_REFERENCE);
...
EIF_TYPED_VALUE F544_2101 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 3941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(543, Current, 3941);
	RTIV(Current, RTAL);
	RTHOOK(1);
