...
extern void F536_2657(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F536_2659(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F536_2660(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F536_2664(EIF_REFERENCE);
...
void F536_2657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 535, Current, 1, 1, 4998);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(535, Current, 4998);
	RTIV(Current, RTAL);
...
void F536_2659 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 535, Current, 0, 1, 4999);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(535, Current, 4999);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		ti4_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_i4);
		ui4_1 = ti4_5;
...
void F536_2660 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 535, Current, 0, 1, 5000);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(535, Current, 5000);
	RTCC(arg1, 535, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F536_2664 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 535, Current, 0, 0, 5001);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(535, Current, 5001);
	RTIV(Current, RTAL);
	RTHOOK(1);
