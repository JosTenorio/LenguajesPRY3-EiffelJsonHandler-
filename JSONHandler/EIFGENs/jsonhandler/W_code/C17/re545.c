...
extern EIF_TYPED_VALUE F545_2073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F545_2074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F545_2075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F545_2076(EIF_REFERENCE);
extern void F545_2077(EIF_REFERENCE);
extern void F545_5146(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F545_2073 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F545_2075 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 3205);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(544, Current, 3205);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F545_2076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 3206);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(544, Current, 3206);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F545_2077 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 3201);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(544, Current, 3201);
	RTIV(Current, RTAL);
...
void F545_5146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 544, Current, 0, 5145);
	RTSA(dtype);
	RTME(dtype, 0);
