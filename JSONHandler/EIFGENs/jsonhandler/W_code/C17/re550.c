...
extern EIF_TYPED_VALUE F550_2420(EIF_REFERENCE);
extern void F550_5064(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 549, Current, 0, 0, 3703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(549, Current, 3703);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F550_2420 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 549, Current, 0, 0, 3701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(549, Current, 3701);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F550_5064 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 549, Current, 0, 5063);
	RTSA(dtype);
	RTME(dtype, 0);
