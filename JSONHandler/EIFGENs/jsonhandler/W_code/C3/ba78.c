...
extern EIF_TYPED_VALUE F78_1153(EIF_REFERENCE);
extern EIF_TYPED_VALUE F78_1154(EIF_REFERENCE);
...
EIF_TYPED_VALUE F78_1153 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 77, Current, 0, 0, 1231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F78_1154)
EIF_TYPED_VALUE F78_1154 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 77, Current, 0, 0, 1232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
