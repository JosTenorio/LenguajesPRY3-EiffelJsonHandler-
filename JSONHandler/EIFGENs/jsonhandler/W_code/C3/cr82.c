...
extern EIF_TYPED_VALUE F82_1161(EIF_REFERENCE);
...
RTOID (F82_1161)
EIF_TYPED_VALUE F82_1161 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 81, Current, 0, 0, 1239);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(81, Current, 1239);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
