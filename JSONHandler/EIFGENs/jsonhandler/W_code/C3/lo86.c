...
extern EIF_TYPED_VALUE F86_1167(EIF_REFERENCE);
...
RTOID (F86_1167)
EIF_TYPED_VALUE F86_1167 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 85, Current, 0, 0, 1245);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(85, Current, 1245);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
