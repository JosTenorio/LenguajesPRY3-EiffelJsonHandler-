...
extern EIF_TYPED_VALUE F85_1168(EIF_REFERENCE);
...
RTOID (F85_1168)
EIF_TYPED_VALUE F85_1168 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 84, Current, 0, 0, 1246);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(84, Current, 1246);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
