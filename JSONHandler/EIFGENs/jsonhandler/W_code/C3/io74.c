...
extern void F74_1144(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F74_1140 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1218);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(73, Current, 1218);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1069, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(763, 33))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1220);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1066, 0x10000000, 1); /* error_code */
	*(EIF_INTEGER_32 *)(Current + RTWA(1066, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {IO_FAILURE}.set_code */
void F74_1144 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 73, Current, 0, 1, 1222);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(73, Current, 1222);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1069, 0x10000000, 1); /* internal_code */
