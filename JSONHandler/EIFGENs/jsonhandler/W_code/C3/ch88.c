...
extern EIF_TYPED_VALUE F88_1169(EIF_REFERENCE);
...
EIF_TYPED_VALUE F88_1169 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1247);
	RTIV(Current, RTAL);
	RTHOOK(1);
