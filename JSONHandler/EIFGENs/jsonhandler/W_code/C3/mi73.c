...
extern EIF_TYPED_VALUE F73_1140(EIF_REFERENCE);
extern EIF_TYPED_VALUE F73_1141(EIF_REFERENCE);
...
EIF_TYPED_VALUE F73_1140 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F73_1141)
EIF_TYPED_VALUE F73_1141 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 72, Current, 0, 0, 1219);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(72, Current, 1219);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
