...
extern EIF_TYPED_VALUE F73_1142(EIF_REFERENCE);
...
RTOID (F73_1142)
EIF_TYPED_VALUE F73_1142 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 72, Current, 0, 0, 1220);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(72, Current, 1220);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
