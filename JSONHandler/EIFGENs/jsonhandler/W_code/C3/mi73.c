...
extern EIF_TYPED_VALUE F73_1138(EIF_REFERENCE);
extern EIF_TYPED_VALUE F73_1139(EIF_REFERENCE);
...
EIF_TYPED_VALUE F73_1138 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F73_1139)
EIF_TYPED_VALUE F73_1139 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 72, Current, 0, 0, 1217);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(72, Current, 1217);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
