...
extern EIF_TYPED_VALUE F76_1063(EIF_REFERENCE);
extern EIF_TYPED_VALUE F76_1064(EIF_REFERENCE);
...
EIF_TYPED_VALUE F76_1063 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 75, Current, 0, 0, 1138);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(75, Current, 1138);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F76_1064)
EIF_TYPED_VALUE F76_1064 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 75, Current, 0, 0, 1139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(75, Current, 1139);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
