...
extern EIF_TYPED_VALUE F84_1164(EIF_REFERENCE);
...
EIF_TYPED_VALUE F84_1164 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 83, Current, 0, 0, 1242);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(83, Current, 1242);
	RTIV(Current, RTAL);
	RTHOOK(1);
