...
extern EIF_TYPED_VALUE F84_1163(EIF_REFERENCE);
...
RTOID (F84_1163)
EIF_TYPED_VALUE F84_1163 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 83, Current, 0, 0, 1241);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(83, Current, 1241);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
