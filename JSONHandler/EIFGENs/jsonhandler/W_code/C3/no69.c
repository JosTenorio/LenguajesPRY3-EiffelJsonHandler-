...
extern EIF_TYPED_VALUE F69_1131(EIF_REFERENCE);
...
EIF_TYPED_VALUE F69_1130 (EIF_REFERENCE Current)
{
	...
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(757, 33))(Current)).it_i4);
...
/* {NO_MORE_MEMORY}.tag */
RTOID (F69_1131)
EIF_TYPED_VALUE F69_1131 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 68, Current, 0, 0, 1209);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 68, Current, 0, 1, 1210);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1065, 0x10000000, 1); /* internal_code */
