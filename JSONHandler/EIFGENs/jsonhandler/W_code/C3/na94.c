...
extern EIF_TYPED_VALUE F94_1298(EIF_REFERENCE, EIF_TYPED_VALUE);
...
static EIF_NATURAL_64 inline_F94_1298 (EIF_POINTER arg1)
{
	#ifdef EIF_WINDOWS
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 93, Current, 1, 1, 1317);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	up1 = arg1;
	tu8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1193, dtype))(Current, up1x)).it_n8);
...
EIF_TYPED_VALUE F94_1298 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 93, Current, 0, 1, 1318);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
body:;
	Result = inline_F94_1298 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
