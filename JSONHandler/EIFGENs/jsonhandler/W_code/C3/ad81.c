...
extern EIF_TYPED_VALUE F81_1162(EIF_REFERENCE);
...
RTOID (F81_1162)
EIF_TYPED_VALUE F81_1162 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 80, Current, 0, 0, 1240);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 1240);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
