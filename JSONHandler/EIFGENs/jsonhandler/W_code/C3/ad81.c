...
extern EIF_TYPED_VALUE F81_1159(EIF_REFERENCE);
...
RTOID (F81_1159)
EIF_TYPED_VALUE F81_1159 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 80, Current, 0, 0, 1237);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 1237);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
