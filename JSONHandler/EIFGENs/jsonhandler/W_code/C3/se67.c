...
extern EIF_TYPED_VALUE F67_1018(EIF_REFERENCE);
...
EIF_TYPED_VALUE F67_1017 (EIF_REFERENCE Current)
{
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(657, 28))(Current)).it_i4);
...
RTOID (F67_1018)
EIF_TYPED_VALUE F67_1018 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 66, Current, 0, 0, 1100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(66, Current, 1100);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
