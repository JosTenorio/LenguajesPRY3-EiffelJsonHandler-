...
extern EIF_TYPED_VALUE F77_1150(EIF_REFERENCE);
extern EIF_TYPED_VALUE F77_1151(EIF_REFERENCE);
...
EIF_TYPED_VALUE F77_1150 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F77_1151)
EIF_TYPED_VALUE F77_1151 (EIF_REFERENCE Current)
{
	GTCX
