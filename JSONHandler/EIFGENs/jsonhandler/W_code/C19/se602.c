...
extern EIF_TYPED_VALUE F602_2094(EIF_REFERENCE);
...
EIF_TYPED_VALUE F602_2094 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 601, Current, 0, 0, 3262);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(601, Current, 3262);
	RTIV(Current, RTAL);
	RTHOOK(1);
