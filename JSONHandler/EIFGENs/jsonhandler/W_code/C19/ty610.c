...
extern EIF_TYPED_VALUE F610_1931(EIF_REFERENCE);
...
EIF_TYPED_VALUE F610_1931 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 609, Current, 0, 0, 2706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(609, Current, 2706);
	RTIV(Current, RTAL);
