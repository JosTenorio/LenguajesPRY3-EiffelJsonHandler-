...
extern void F443_2570(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F443_2572(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F443_2573(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F443_2577(EIF_REFERENCE);
...
void F443_2570 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 442, Current, 1, 1, 4894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(442, Current, 4894);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uu1_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2107, dtype))(Current, uu1_1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uu1_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2109, dtype))(Current, uu1_1x);
			RTHOOK(8);
...
void F443_2572 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 442, Current, 0, 1, 4895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(442, Current, 4895);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1812, "item", arg1))(arg1)).it_n1);
		uu1_1 = tu1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2108, dtype))(Current, uu1_1x);
		RTHOOK(8);
...
void F443_2573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 442, Current, 0, 1, 4892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(442, Current, 4892);
	RTCC(arg1, 442, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F443_2577 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 442, Current, 0, 0, 4893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(442, Current, 4893);
	RTIV(Current, RTAL);
	RTHOOK(1);
