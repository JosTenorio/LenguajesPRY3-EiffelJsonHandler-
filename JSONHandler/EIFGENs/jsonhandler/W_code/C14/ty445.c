...
extern EIF_TYPED_VALUE F445_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F445_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 444, Current, 0, 0, 2018);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(444, Current, 2018);
	RTIV(Current, RTAL);
