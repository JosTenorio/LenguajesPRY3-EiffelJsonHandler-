...
extern EIF_TYPED_VALUE F431_1830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F431_1830 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 430, Current, 0, 0, 1929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(430, Current, 1929);
	RTIV(Current, RTAL);
