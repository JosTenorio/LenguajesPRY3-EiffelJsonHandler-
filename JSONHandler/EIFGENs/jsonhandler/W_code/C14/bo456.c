...
extern EIF_TYPED_VALUE F456_1985(EIF_REFERENCE);
extern void F456_5057(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F456_1985 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 455, Current, 0, 0, 3048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(455, Current, 3048);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F456_5057 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 455, Current, 0, 5056);
	RTSA(dtype);
	RTME(dtype, 0);
