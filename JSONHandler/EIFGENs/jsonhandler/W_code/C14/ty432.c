...
extern EIF_TYPED_VALUE F432_1926(EIF_REFERENCE);
...
EIF_TYPED_VALUE F432_1926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 431, Current, 0, 0, 2698);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(431, Current, 2698);
	RTIV(Current, RTAL);
