...
extern EIF_TYPED_VALUE F456_2069(EIF_REFERENCE);
extern void F456_5144(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F456_2069 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 455, Current, 0, 0, 3117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(455, Current, 3117);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F456_5144 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 455, Current, 0, 5143);
	RTSA(dtype);
	RTME(dtype, 0);
