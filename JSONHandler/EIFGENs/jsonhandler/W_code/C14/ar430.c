...
extern void F430_2004(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F430_2004 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 429, Current, 0, 1, 3352);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(429, Current, 3352);
	RTCC(arg1, 429, l_feature_name, 1, RTWCT(1800, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1800, 0xF80001AC, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1800, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1787, 0xF80001B5, 0); /* area */
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 429, Current, 0, 0, 3354);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(429, Current, 3354);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 429, Current, 0, 0, 3355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(429, Current, 3355);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1770, 430))(Current)).it_b);
		tb1 = tb2;
	}
