...
extern EIF_TYPED_VALUE F441_2504(EIF_REFERENCE);
extern EIF_TYPED_VALUE F441_2507(EIF_REFERENCE);
extern void F441_5155(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F441_2504 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 440, Current, 0, 0, 3783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 3783);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F441_2507 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 440, Current, 0, 0, 3784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 3784);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F441_5155 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 440, Current, 0, 5154);
	RTSA(dtype);
	RTME(dtype, 0);
