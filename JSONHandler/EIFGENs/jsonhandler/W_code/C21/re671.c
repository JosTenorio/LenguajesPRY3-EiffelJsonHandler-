...
extern EIF_TYPED_VALUE F671_2503(EIF_REFERENCE);
extern EIF_TYPED_VALUE F671_2506(EIF_REFERENCE);
extern void F671_5152(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F671_2503 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 3791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(670, Current, 3791);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F671_2506 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 3792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(670, Current, 3792);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F671_5152 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 670, Current, 0, 5151);
	RTSA(dtype);
	RTME(dtype, 0);
