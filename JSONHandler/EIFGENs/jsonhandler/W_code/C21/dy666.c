...
extern EIF_TYPED_VALUE F666_2701(EIF_REFERENCE);
extern void F666_2707(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F666_2708(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F666_2711(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F666_2712(EIF_REFERENCE);
extern EIF_TYPED_VALUE F666_2713(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F666_2701 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 665, Current, 0, 0, 6185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6185);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DYNAMIC_CHAIN}.prune */
void F666_2707 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 665, Current, 0, 1, 6186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6186);
	RTIV(Current, RTAL);
...
void F666_2708 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 665, Current, 0, 1, 6187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6187);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F666_2711 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 665, Current, 3, 1, 6188);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6188);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1717, "item", loc3))(loc3)).it_b);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1766, "target_index", loc3))(loc3)).it_i4);
...
void F666_2712 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 665, Current, 0, 0, 6189);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6189);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F666_2713 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 665, Current, 2, 1, 6190);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6190);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1872, "extend", Result))(Result, ub1x);
		RTHOOK(9);
