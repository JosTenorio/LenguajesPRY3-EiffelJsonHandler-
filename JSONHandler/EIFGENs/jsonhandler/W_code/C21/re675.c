...
extern EIF_TYPED_VALUE F675_2073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F675_2074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F675_2075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F675_2076(EIF_REFERENCE);
extern void F675_2077(EIF_REFERENCE);
extern void F675_5146(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F675_2073 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F675_2074 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F675_2075 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 674, Current, 0, 0, 3211);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(674, Current, 3211);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F675_2076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 674, Current, 0, 0, 3212);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(674, Current, 3212);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F675_2077 (EIF_REFERENCE Current)
{
	GTCX
...
void F675_5146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 674, Current, 0, 5145);
	RTSA(dtype);
	RTME(dtype, 0);
