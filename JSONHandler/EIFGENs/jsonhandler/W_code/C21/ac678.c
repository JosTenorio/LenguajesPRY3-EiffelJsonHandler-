...
extern EIF_TYPED_VALUE F678_2014(EIF_REFERENCE);
extern void F678_5054(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F678_2014 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 677, Current, 0, 0, 3216);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(677, Current, 3216);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F678_5054 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 677, Current, 0, 5053);
	RTSA(dtype);
	RTME(dtype, 0);
