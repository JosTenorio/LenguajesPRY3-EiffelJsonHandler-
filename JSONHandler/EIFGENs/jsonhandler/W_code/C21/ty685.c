...
extern EIF_TYPED_VALUE F685_1917(EIF_REFERENCE);
...
EIF_TYPED_VALUE F685_1917 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 684, Current, 0, 0, 2022);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(684, Current, 2022);
	RTIV(Current, RTAL);
