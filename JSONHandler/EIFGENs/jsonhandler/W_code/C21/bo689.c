...
extern EIF_TYPED_VALUE F689_2085(EIF_REFERENCE);
extern void F689_4891(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F689_2085 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 688, Current, 0, 0, 3835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(688, Current, 3835);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F689_4891 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 688, Current, 0, 4890);
	RTSA(dtype);
	RTME(dtype, 0);
