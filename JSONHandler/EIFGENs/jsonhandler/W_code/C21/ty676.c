...
extern EIF_TYPED_VALUE F676_1926(EIF_REFERENCE);
...
EIF_TYPED_VALUE F676_1926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 2702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 2702);
	RTIV(Current, RTAL);
