...
extern EIF_TYPED_VALUE F692_2090(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F692_2093(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F692_2095(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F692_2090 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 691, Current, 0, 1, 3935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(691, Current, 3935);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F692_2093 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 691, Current, 1, 1, 3936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(691, Current, 3936);
	{
...
void F692_2095 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 691, Current, 0, 1, 3937);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(691, Current, 3937);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	for (;;) {
		...
		RTHOOK(3);
		ur4_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1868, dtype))(Current, ur4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
