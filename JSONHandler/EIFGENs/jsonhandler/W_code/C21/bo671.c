...
extern EIF_TYPED_VALUE F671_1978(EIF_REFERENCE);
extern void F671_5052(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F671_1978 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 3054);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(670, Current, 3054);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F671_5052 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 670, Current, 0, 5051);
	RTSA(dtype);
	RTME(dtype, 0);
