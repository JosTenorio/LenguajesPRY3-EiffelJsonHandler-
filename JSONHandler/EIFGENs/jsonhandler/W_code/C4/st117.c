...
extern void F117_2003(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F117_2004(EIF_REFERENCE);
extern EIF_TYPED_VALUE F117_2005(EIF_REFERENCE);
extern EIF_TYPED_VALUE F117_2006(EIF_REFERENCE);
extern EIF_TYPED_VALUE F117_2007(EIF_REFERENCE);
extern EIF_TYPED_VALUE F117_2008(EIF_REFERENCE);
...
void F117_2003 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 116, Current, 1, 1, 3315);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(116, Current, 3315);
	RTCC(arg1, 116, l_feature_name, 1, RTWCT(1803, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1803, 0xF80000B1, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1803, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(3,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3443, "area", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTAR(Current, tr2);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(1793, dtype)) = (EIF_INTEGER_32) loc1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 1802, 0x10000000, 1); /* area_first_index */
...
EIF_TYPED_VALUE F117_2004 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F117_2005 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 116, Current, 0, 0, 3317);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(116, Current, 3317);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000074, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(116, 0x01).id);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1803, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F117_2006 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 116, Current, 0, 0, 3318);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(116, Current, 3318);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F117_2007 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F117_2008 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
