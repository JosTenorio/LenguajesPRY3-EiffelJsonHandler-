...
extern void F110_4880(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F110_4880 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 109, Current, 0, 4879);
	RTSA(dtype);
	RTME(dtype, 0);
