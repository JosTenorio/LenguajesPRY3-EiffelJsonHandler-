...
extern EIF_TYPED_VALUE F130_3053(EIF_REFERENCE);
extern EIF_TYPED_VALUE F130_3054(EIF_REFERENCE);
extern EIF_TYPED_VALUE F130_3055(EIF_REFERENCE);
extern EIF_TYPED_VALUE F130_3057(EIF_REFERENCE);
extern void F130_3062(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F130_3053 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(2443,Dtype(Current)));
	return r;
}


/* {RT_DBG_VALUE_RECORD}.type */
EIF_TYPED_VALUE F130_3054 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(2444,Dtype(Current)));
	return r;
}
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 129, Current, 0, 0, 7083);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(129, Current, 7083);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F130_3062 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 129, Current, 0, 1, 7084);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(129, Current, 7084);
	RTCC(arg1, 129, l_feature_name, 1, RTWCT(2445, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2445, 0xF8000085, 0); /* breakable_info */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(2445, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
