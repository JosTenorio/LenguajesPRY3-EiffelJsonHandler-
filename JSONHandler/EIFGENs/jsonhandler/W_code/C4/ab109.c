...
extern EIF_TYPED_VALUE F109_1781(EIF_REFERENCE);
extern void F109_4874(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F109_1781 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 108, Current, 0, 0, 1885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(108, Current, 1885);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F109_4874 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 108, Current, 0, 4873);
	RTSA(dtype);
	RTME(dtype, 0);
