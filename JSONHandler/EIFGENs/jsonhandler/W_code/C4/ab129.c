...
extern EIF_TYPED_VALUE F129_3005(EIF_REFERENCE);
extern void F129_5167(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F129_3005 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 128, Current, 0, 0, 6481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(128, Current, 6481);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F129_5167 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 128, Current, 0, 5166);
	RTSA(dtype);
	RTME(dtype, 0);
