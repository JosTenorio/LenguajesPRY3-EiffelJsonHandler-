...
static const EIF_TYPE_INDEX egt_0_125 [] = {0xFF01,184,0xFFFF};
static const EIF_TYPE_INDEX egt_1_125 [] = {0xFF01,197,124,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_125 [] = {0xFF01,184,0xFFFF};
static const EIF_TYPE_INDEX egt_10_125 [] = {0xFF01,184,0xFFFF};
static const EIF_TYPE_INDEX egt_11_125 [] = {0xFF01,17,0xFFFF};
static const EIF_TYPE_INDEX egt_12_125 [] = {0xFF01,124,0xFFFF};
static const EIF_TYPE_INDEX egt_13_125 [] = {0xFF01,125,0xFFFF};
...
static const struct desc_info desc_125[] = {
	...
	{EIF_GENERIC(egt_13_125), 5112, 0xFFFFFFFF},
};
void Init125(void)
{
	IDSC(desc_125, 0, 124);
	IDSC(desc_125 + 1, 2, 124);
	IDSC(desc_125 + 32, 39, 124);
}
