...
static EIF_TYPED_VALUE F4_35_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F4_35(EIF_REFERENCE);
extern void F4_36(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {VERSIONABLE}.version */
static EIF_TYPED_VALUE F4_35_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 3, Current, 0, 0, 51);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F4_35 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT32;
...
void F4_36 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F4_37 (EIF_REFERENCE Current)
{
	GTCX
