...
static const EIF_TYPE_INDEX egt_1_5 [] = {0xFF01,196,4,0xFFFF};
...
static const struct desc_info desc_5[] = {
	...
	{EIF_NON_GENERIC(0x0151 /*168*/), 58, 32},
	{EIF_GENERIC(egt_13_5), 59, 0},
	{EIF_GENERIC(egt_14_5), 60, 8},
	{EIF_GENERIC(egt_15_5), 61, 16},
	{EIF_GENERIC(egt_16_5), 62, 24},
