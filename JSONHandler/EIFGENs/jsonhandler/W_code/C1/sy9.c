...
extern void F9_4867(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F9_208 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 8, Current, 0, 0, 212);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(8, Current, 212);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F9_4867 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 8, Current, 0, 4866);
	RTSA(Dtype(Current));
