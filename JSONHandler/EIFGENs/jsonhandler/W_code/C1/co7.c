...
{
	GTCX
	RTOTC (F7_81,73,RTMS_EX_H("UTF-7",5,1414538039));
}
...
{
	GTCX
	RTOTC (F7_82,74,RTMS_EX_H("UTF-8",5,1414538040));
}
...
{
	GTCX
	RTOTC (F7_83,75,RTMS_EX_H("UTF-16",6,1345128758));
}
...
{
	GTCX
	RTOTC (F7_84,76,RTMS_EX_H("UTF-32",6,1345129266));
}
...
{
	GTCX
	RTOTC (F7_85,77,RTMS_EX_H("UTF-16LE",8,312185413));
}
...
{
	GTCX
	RTOTC (F7_86,78,RTMS_EX_H("UTF-32LE",8,345477701));
}
...
{
	GTCX
	RTOTC (F7_87,79,RTMS_EX_H("UTF-16BE",8,312182853));
}
...
{
	GTCX
	RTOTC (F7_88,80,RTMS_EX_H("UTF-32BE",8,345475141));
}
