...
extern EIF_TYPED_VALUE F20_594(EIF_REFERENCE);
extern EIF_TYPED_VALUE F20_595(EIF_REFERENCE);
...
#define Result RTOTRR
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(2332, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
...
RTOID (F20_594)
EIF_TYPED_VALUE F20_594 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(19, Current, 671);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000225, 0,0); /* Result */
...
RTOID (F20_595)
EIF_TYPED_VALUE F20_595 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(19, Current, 672);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000225, 0,0); /* Result */
