...
extern EIF_TYPED_VALUE F20_596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F20_597(EIF_REFERENCE);
...
RTOID (F20_596)
EIF_TYPED_VALUE F20_596 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(19, Current, 673);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000239, 0,0); /* Result */
...
RTOID (F20_597)
EIF_TYPED_VALUE F20_597 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(19, Current, 674);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000239, 0,0); /* Result */
