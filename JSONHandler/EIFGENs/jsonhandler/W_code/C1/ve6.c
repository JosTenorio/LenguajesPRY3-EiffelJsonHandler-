...
/* {VERSIONABLE}.version */
static EIF_TYPED_VALUE F6_76_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 5, Current, 0, 0, 67);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F6_76 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT32;
	r.it_n4 = *(EIF_NATURAL_32 *)(Current + RTWA(79,Dtype(Current)));
	return r;
}
...
#define arg1 arg1x.it_n4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 79, 0x38000000, 1); /* version */
	*(EIF_NATURAL_32 *)(Current + RTWA(79, dtype)) = (EIF_NATURAL_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("version_set", EX_POST);
		tu4_1 = *(EIF_NATURAL_32 *)(Current + RTWA(79, dtype));
...
void F6_78 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		tu4_2 = *(EIF_NATURAL_32 *)(Current + RTWA(79, dtype));
		tu4_1 = tu4_2;
		in_assertion = 0;
	}
	RTHOOK(1);
	RTDBGAA(Current, dtype, 79, 0x38000000, 1); /* version */
	(*(EIF_NATURAL_32 *)(Current + RTWA(79, dtype))) += (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
