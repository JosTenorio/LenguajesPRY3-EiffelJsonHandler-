...
extern void F19_5125(EIF_REFERENCE, int);
...
#define uc1 uc1x.it_c1
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		if (tb1) {
			...
			RTHOOK(10);
			ur1 = RTCCL(loc1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3580, "prepend", Result))(Result, ur1x);
		}
	}
	RTVI(Current, RTAL);
	RTRS;
...
body:;
	...
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(3401, "substring", tr1))(tr1, ui4_1x, ui4_2x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		for (;;) {
			RTHOOK(19);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3361, "capacity", loc2))(loc2)).it_i4);
			...
			tc1 = *(EIF_CHARACTER_8 *)(Current + RTWA(533, dtype));
			uc1 = tc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1881, "extend", loc2))(loc2, uc1x);
			RTHOOK(22);
			RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
			loc3++;
		}
		RTHOOK(23);
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3361, "capacity", loc1))(loc1)).it_i4);
...
void F19_5125 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 18, Current, 0, 5124);
	RTSA(dtype);
	RTME(dtype, 0);
