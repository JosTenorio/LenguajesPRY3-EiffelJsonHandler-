...
EIF_TYPED_VALUE F30_703 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 29, Current, 0, 0, 781);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 29, Current, 5, 1, 782);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (tb1) {
		...
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3446, "adjust", loc4))(loc4);
		RTHOOK(4);
		...
		if ((EIF_BOOLEAN) (loc2 > ((EIF_INTEGER_32) 1L))) {
			...
			ti4_1 = *(EIF_INTEGER_32 *)(loc4 + RTVA(3482, "count", loc4));
			...
			if (tb2) {
				tw1 = (EIF_CHARACTER_32) (EIF_CHARACTER_8) '[';
				uw1 = tw1;
				ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1888, "occurrences", loc4))(loc4, uw1x)).it_i4);
				tw1 = (EIF_CHARACTER_32) (EIF_CHARACTER_8) ']';
				uw1 = tw1;
				ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1888, "occurrences", loc4))(loc4, uw1x)).it_i4);
				...
				if (tb1) {
					...
					if ((EIF_BOOLEAN)(loc5 != NULL)) {
						...
						for (;;) {
							RTHOOK(17);
							tb1 = '\01';
							tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1862, "after", loc5))(loc5)).it_b);
							if (!tb2) {
							...
							RTHOOK(18);
							RTDBGAL(0, 0x04000000, 1,0); /* Result */
							tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", loc5))(loc5)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
							ur1 = RTCCL(tr1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 29, Current, 1, 1, 783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		RTHOOK(4);
		ur1 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2268, "search", loc1))(loc1, ur1x);
		RTHOOK(5);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2259, "found", loc1))(loc1)).it_b);
		if (tb1) {
			RTHOOK(6);
			RTDBGAL(0, 0xF80000B0, 0,0); /* Result */
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2243, "found_item", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 29, Current, 3, 1, 784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		*(EIF_CHARACTER_32 *)tr1 = tw1;
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3141, "is_alpha", tr1))(tr1)).it_b);
		if (tb2) {
			RTHOOK(20);
			RTDBGAL(0, 0x04000000, 1,0); /* Result */
			Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			for (;;) {
				...
				*(EIF_CHARACTER_32 *)tr1 = loc3;
				tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3141, "is_alpha", tr1))(tr1)).it_b);
				if (!tb4) {
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 29, Current, 5, 1, 785);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 29, Current, 0, 0, 786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,548,0xFF01,184,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
{
	GTCX
	RTOTC (F30_711,790,RTMS_EX_H("attached",8,174222180));
}
...
{
	GTCX
	RTOTC (F30_712,791,RTMS_EX_H("detachable",10,1071588197));
}
...
{
	GTCX
	RTOTC (F30_714,780,RTMS_EX_H("separate",8,1461880421));
}
...
{
	GTCX
	RTOTC (F30_715,781,RTMS_EX_H("TYPE",4,1415139397));
}
