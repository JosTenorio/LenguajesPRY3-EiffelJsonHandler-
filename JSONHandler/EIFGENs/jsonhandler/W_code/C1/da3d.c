...
static const EIF_TYPE_INDEX egt_13_3 [] = {0xFF01,549,0xFF01,191,0xFF01,184,0xFFFF};
...
static const struct desc_info desc_3[] = {
	...
	{EIF_GENERIC(egt_16_3), 37, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0151 /*168*/), 38, 0xFFFFFFFF},
