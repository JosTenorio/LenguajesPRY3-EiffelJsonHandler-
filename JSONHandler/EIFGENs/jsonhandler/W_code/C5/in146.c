...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 145, Current, 0, 1, 9425);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F146_3725 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 145, Current, 0, 0, 9437);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 145, Current, 0, 0, 9441);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 145, Current, 0, 1, 9443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(145, Current, 9443);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x0C000000, 1,0); /* Result */
	ui4_1 = arg1;
