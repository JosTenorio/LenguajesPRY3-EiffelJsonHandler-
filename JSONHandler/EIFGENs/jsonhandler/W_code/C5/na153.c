...
EIF_TYPED_VALUE F153_3912 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT16;
	r.it_n2 = *(EIF_NATURAL_16 *)(Current + RTWA(3004,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F153_3913 (EIF_REFERENCE Current)
{
	...
	tu2_1 = *(EIF_NATURAL_16 *)(Current + RTWA(3004, dtype));
...
#define uu2_1 uu2_1x.it_n2
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3009, "set_item", Result))(Result, uu2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
body:;
	...
	tu2_1 = *(EIF_NATURAL_16 *)(Current + RTWA(3004, dtype));
	tu2_2 = *(EIF_NATURAL_16 *)(arg1 + RTVA(3004, "item", arg1));
...
body:;
	RTHOOK(2);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tu2_1 = *(EIF_NATURAL_16 *)(arg1 + RTVA(3004, "item", arg1));
	tu2_2 = *(EIF_NATURAL_16 *)(Current + RTWA(3004, dtype));
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN)(tu2_1 == tu2_2);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
#define arg1 arg1x.it_n2
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3004, 0x34000000, 1); /* item */
	*(EIF_NATURAL_16 *)(Current + RTWA(3004, dtype)) = (EIF_NATURAL_16) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
body:;
	...
	tu2_1 = *(EIF_NATURAL_16 *)(arg1 + RTVA(3004, "item", arg1));
	uu2_1 = tu2_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3009, dtype))(Current, uu2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("item_set", EX_POST);
		tu2_1 = *(EIF_NATURAL_16 *)(Current + RTWA(3004, dtype));
...
body:;
	RTHOOK(2);
	RTDBGAL(0, 0x30000000, 1,0); /* Result */
	tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3020, dtype))(Current)).it_n1);
	Result = (EIF_NATURAL_8) tu1_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
body:;
	...
	if ((EIF_BOOLEAN) (arg1 > ((EIF_INTEGER_32) 0L))) {
		...
		RTNHOOK(4,1);
		tu2_1 = *(EIF_NATURAL_16 *)(tr1 + RTVA(3004, "item", tr1));
		Result = (EIF_NATURAL_16) tu2_1;
	} else {
		RTHOOK(5);
		RTDBGAL(0, 0x34000000, 1,0); /* Result */
...
#define uu2_1 uu2_1x.it_n2
	...
	tu2_1 = *(EIF_NATURAL_16 *)(Current + RTWA(3004, dtype));
	uu2_1 = tu2_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3430, "append_natural_16", Result))(Result, uu2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_not_void", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
