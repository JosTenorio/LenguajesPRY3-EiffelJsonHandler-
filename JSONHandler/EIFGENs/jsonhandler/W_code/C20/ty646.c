...
extern EIF_TYPED_VALUE F646_1931(EIF_REFERENCE);
...
EIF_TYPED_VALUE F646_1931 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 645, Current, 0, 0, 2707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(645, Current, 2707);
	RTIV(Current, RTAL);
