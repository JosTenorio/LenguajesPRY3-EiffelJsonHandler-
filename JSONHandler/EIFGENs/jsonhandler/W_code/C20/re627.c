...
extern EIF_TYPED_VALUE F627_2087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F627_2088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F627_2089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F627_2090(EIF_REFERENCE);
extern void F627_2091(EIF_REFERENCE);
extern void F627_4892(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F627_2087 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F627_2088 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F627_2089 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 626, Current, 0, 0, 3889);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(626, Current, 3889);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F627_2090 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 626, Current, 0, 0, 3890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(626, Current, 3890);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F627_2091 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 626, Current, 0, 0, 3891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(626, Current, 3891);
	RTIV(Current, RTAL);
...
void F627_4892 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 626, Current, 0, 4891);
	RTSA(dtype);
	RTME(dtype, 0);
