...
extern EIF_TYPED_VALUE F565_1944(EIF_REFERENCE);
extern EIF_TYPED_VALUE F565_1945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F565_1946(EIF_REFERENCE);
extern void F565_1947(EIF_REFERENCE);
extern void F565_1948(EIF_REFERENCE);
extern EIF_TYPED_VALUE F565_1950(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F565_1944 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 564, Current, 0, 0, 2743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(564, Current, 2743);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F565_1945 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F565_1946 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 564, Current, 0, 0, 2745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(564, Current, 2745);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F565_1947 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 564, Current, 0, 0, 2746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F565_1948 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 564, Current, 0, 0, 2747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(564, Current, 2747);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F565_1950 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 564, Current, 2, 1, 2748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
