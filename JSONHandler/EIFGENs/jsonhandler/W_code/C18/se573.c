...
extern EIF_TYPED_VALUE F573_2093(EIF_REFERENCE);
...
EIF_TYPED_VALUE F573_2093 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 572, Current, 0, 0, 3261);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(572, Current, 3261);
	RTIV(Current, RTAL);
	RTHOOK(1);
