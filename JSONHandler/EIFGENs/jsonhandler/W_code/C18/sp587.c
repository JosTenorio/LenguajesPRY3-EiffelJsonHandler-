...
extern void F587_2010(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F587_2011(EIF_REFERENCE);
extern EIF_TYPED_VALUE F587_2012(EIF_REFERENCE);
extern EIF_TYPED_VALUE F587_2013(EIF_REFERENCE);
...
void F587_2010 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 586, Current, 0, 1, 3424);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(586, Current, 3424);
	RTCC(arg1, 586, l_feature_name, 1, RTWCT(1787, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1787, 0xF8000243, 0); /* target */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F587_2011 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F587_2012 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 586, Current, 0, 0, 3426);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(586, Current, 3426);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F587_2013 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
