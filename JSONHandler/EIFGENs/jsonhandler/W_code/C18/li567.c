...
extern EIF_TYPED_VALUE F567_2653(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F567_2654(EIF_REFERENCE);
extern EIF_TYPED_VALUE F567_2655(EIF_REFERENCE);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F567_2653 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 566, Current, 2, 1, 4955);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(566, Current, 4955);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_n8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F567_2654 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 566, Current, 0, 0, 4956);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(566, Current, 4956);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F567_2655 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 566, Current, 0, 0, 4957);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(566, Current, 4957);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1858, dtype))(Current)).it_i4);
