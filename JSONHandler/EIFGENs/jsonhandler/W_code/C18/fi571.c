...
extern EIF_TYPED_VALUE F571_2070(EIF_REFERENCE);
extern void F571_5147(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F571_2070 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 570, Current, 0, 0, 3125);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(570, Current, 3125);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F571_5147 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 570, Current, 0, 5146);
	RTSA(dtype);
	RTME(dtype, 0);
