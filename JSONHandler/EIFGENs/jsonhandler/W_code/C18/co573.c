...
extern EIF_TYPED_VALUE F573_2033(EIF_REFERENCE);
extern EIF_TYPED_VALUE F573_2034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F573_2035(EIF_REFERENCE);
extern void F573_2036(EIF_REFERENCE);
extern void F573_2037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F573_2039(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F573_2033 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 572, Current, 0, 0, 2835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(572, Current, 2835);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F573_2034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F573_2035 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 572, Current, 0, 0, 2837);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(572, Current, 2837);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F573_2036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 572, Current, 0, 0, 2838);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(572, Current, 2838);
	RTIV(Current, RTAL);
...
void F573_2037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 572, Current, 0, 0, 2839);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(572, Current, 2839);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F573_2039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 572, Current, 2, 1, 2840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(572, Current, 2840);
	{
