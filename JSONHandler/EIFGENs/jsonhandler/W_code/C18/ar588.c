...
extern void F588_1977(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F588_1978(EIF_REFERENCE);
extern EIF_TYPED_VALUE F588_1979(EIF_REFERENCE);
extern EIF_TYPED_VALUE F588_1980(EIF_REFERENCE);
extern EIF_TYPED_VALUE F588_1981(EIF_REFERENCE);
...
void F588_1977 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 587, Current, 0, 1, 2606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(587, Current, 2606);
	RTCC(arg1, 587, l_feature_name, 1, RTWCT(1806, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1806, 0xF8000234, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 587, Current, 0, 0, 2608);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(587, Current, 2608);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F588_1980 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 587, Current, 0, 0, 2609);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(587, Current, 2609);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F588_1981 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
