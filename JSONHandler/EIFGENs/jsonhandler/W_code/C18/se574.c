...
extern EIF_TYPED_VALUE F574_2000(EIF_REFERENCE);
...
EIF_TYPED_VALUE F574_2000 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 573, Current, 0, 0, 3166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(573, Current, 3166);
	RTIV(Current, RTAL);
	RTHOOK(1);
