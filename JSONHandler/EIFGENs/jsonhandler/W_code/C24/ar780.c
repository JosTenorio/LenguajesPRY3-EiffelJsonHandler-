...
extern void F780_1977(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F780_1978(EIF_REFERENCE);
extern EIF_TYPED_VALUE F780_1979(EIF_REFERENCE);
...
void F780_1977 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 779, Current, 0, 1, 2618);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(779, Current, 2618);
	RTCC(arg1, 779, l_feature_name, 1, RTWCT(1806, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1806, 0xF80002EB, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F780_1978 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F780_1979 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 2620);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(779, Current, 2620);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 2621);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
