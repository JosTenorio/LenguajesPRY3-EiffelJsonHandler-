...
extern void F776_1980(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F776_1981(EIF_REFERENCE);
extern EIF_TYPED_VALUE F776_1982(EIF_REFERENCE);
extern EIF_TYPED_VALUE F776_1983(EIF_REFERENCE);
extern EIF_TYPED_VALUE F776_1984(EIF_REFERENCE);
extern EIF_TYPED_VALUE F776_1985(EIF_REFERENCE);
...
void F776_1980 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 775, Current, 0, 1, 2623);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 2623);
	RTCC(arg1, 775, l_feature_name, 1, RTWCT(1809, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1809, 0xF80002FE, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F776_1982 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 775, Current, 0, 0, 2625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 2625);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F776_1983 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 775, Current, 0, 0, 2626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 2626);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F776_1984 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F776_1985 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
