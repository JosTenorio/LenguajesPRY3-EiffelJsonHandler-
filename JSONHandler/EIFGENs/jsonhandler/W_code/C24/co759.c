...
extern EIF_TYPED_VALUE F759_2034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_2035(EIF_REFERENCE);
extern void F759_2036(EIF_REFERENCE);
extern void F759_2037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_2039(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F759_2034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F759_2035 (EIF_REFERENCE Current)
{
	GTCX
...
void F759_2036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 2850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F759_2037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 2851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 2851);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F759_2039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 758, Current, 2, 1, 2852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 2852);
	{
