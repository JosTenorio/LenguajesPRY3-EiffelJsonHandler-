...
extern EIF_TYPED_VALUE F778_2072(EIF_REFERENCE);
extern void F778_5148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F778_2072 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 777, Current, 0, 0, 3153);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(777, Current, 3153);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F778_5148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 777, Current, 0, 5147);
	RTSA(dtype);
	RTME(dtype, 0);
