...
extern EIF_TYPED_VALUE F760_2072(EIF_REFERENCE);
extern void F760_5149(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F760_2072 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 759, Current, 0, 0, 3131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(759, Current, 3131);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F760_5149 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 759, Current, 0, 5148);
	RTSA(dtype);
	RTME(dtype, 0);
