...
extern EIF_TYPED_VALUE F760_2070(EIF_REFERENCE);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F760_2070 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 759, Current, 0, 0, 3129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(759, Current, 3129);
	RTIV(Current, RTAL);
	RTHOOK(1);
