...
extern EIF_TYPED_VALUE F768_1987(EIF_REFERENCE);
extern EIF_TYPED_VALUE F768_1988(EIF_REFERENCE);
extern EIF_TYPED_VALUE F768_1989(EIF_REFERENCE);
extern EIF_TYPED_VALUE F768_1990(EIF_REFERENCE);
extern void F768_1991(EIF_REFERENCE);
extern void F768_5058(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F768_1987 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F768_1988 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F768_1989 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 767, Current, 0, 0, 3132);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(767, Current, 3132);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F768_1990 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 767, Current, 0, 0, 3133);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(767, Current, 3133);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F768_1991 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 767, Current, 0, 0, 3134);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(767, Current, 3134);
	RTIV(Current, RTAL);
...
void F768_5058 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 767, Current, 0, 5057);
	RTSA(dtype);
	RTME(dtype, 0);
