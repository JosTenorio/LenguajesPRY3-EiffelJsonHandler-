...
extern void F266_2713(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F266_2715(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F266_2716(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F266_2720(EIF_REFERENCE);
...
void F266_2713 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 265, Current, 1, 1, 6249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(265, Current, 6249);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uw1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2216, dtype))(Current, uw1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uw1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2218, dtype))(Current, uw1x);
			RTHOOK(8);
...
void F266_2715 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 265, Current, 0, 1, 6250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(265, Current, 6250);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1880, "item", arg1))(arg1)).it_c4);
		uw1 = tw1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2217, dtype))(Current, uw1x);
		RTHOOK(8);
...
void F266_2716 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 265, Current, 0, 1, 6251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(265, Current, 6251);
	RTCC(arg1, 265, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F266_2720 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 265, Current, 0, 0, 6252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(265, Current, 6252);
	RTIV(Current, RTAL);
	RTHOOK(1);
