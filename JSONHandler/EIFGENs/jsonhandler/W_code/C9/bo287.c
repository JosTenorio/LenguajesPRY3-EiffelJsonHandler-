...
extern EIF_TYPED_VALUE F287_2074(EIF_REFERENCE);
extern void F287_5150(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F287_2074 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 286, Current, 0, 0, 3135);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(286, Current, 3135);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F287_5150 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 286, Current, 0, 5149);
	RTSA(dtype);
	RTME(dtype, 0);
