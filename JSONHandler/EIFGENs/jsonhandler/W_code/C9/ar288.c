...
extern void F288_1977(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F288_1978(EIF_REFERENCE);
extern EIF_TYPED_VALUE F288_1979(EIF_REFERENCE);
...
void F288_1977 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 287, Current, 0, 1, 2558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(287, Current, 2558);
	RTCC(arg1, 287, l_feature_name, 1, RTWCT(1806, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1806, 0xF8000109, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F288_1978 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F288_1979 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 287, Current, 0, 0, 2560);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(287, Current, 2560);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 287, Current, 0, 0, 2561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
