...
extern EIF_TYPED_VALUE F267_2709(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F267_2710(EIF_REFERENCE);
extern EIF_TYPED_VALUE F267_2711(EIF_REFERENCE);
extern void F267_4897(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F267_2709 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 266, Current, 2, 1, 6201);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(266, Current, 6201);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tw2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1880, "item", arg1))(arg1)).it_c4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F267_2710 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 266, Current, 0, 0, 6202);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(266, Current, 6202);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F267_2711 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 266, Current, 0, 0, 6203);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(266, Current, 6203);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1842, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F267_4897 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 266, Current, 0, 4896);
	RTSA(dtype);
	RTME(dtype, 0);
