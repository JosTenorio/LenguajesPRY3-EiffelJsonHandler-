...
extern EIF_TYPED_VALUE F271_2034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F271_2035(EIF_REFERENCE);
extern void F271_2036(EIF_REFERENCE);
extern void F271_2037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F271_2039(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F271_2034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F271_2035 (EIF_REFERENCE Current)
{
	GTCX
...
void F271_2036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 270, Current, 0, 0, 2790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F271_2037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 270, Current, 0, 0, 2791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(270, Current, 2791);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F271_2039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 270, Current, 2, 1, 2792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(270, Current, 2792);
	{
