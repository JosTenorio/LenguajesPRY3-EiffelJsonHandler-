...
extern EIF_TYPED_VALUE F278_1830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F278_1830 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 277, Current, 0, 0, 1925);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(277, Current, 1925);
	RTIV(Current, RTAL);
