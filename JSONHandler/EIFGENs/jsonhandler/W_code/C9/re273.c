...
extern EIF_TYPED_VALUE F273_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F273_2420(EIF_REFERENCE);
extern void F273_5064(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F273_2417 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 3685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(272, Current, 3685);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F273_2420 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 3683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(272, Current, 3683);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F273_5064 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 272, Current, 0, 5063);
	RTSA(dtype);
	RTME(dtype, 0);
