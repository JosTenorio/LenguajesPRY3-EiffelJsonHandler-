...
extern EIF_TYPED_VALUE F285_1944(EIF_REFERENCE);
extern EIF_TYPED_VALUE F285_1945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F285_1946(EIF_REFERENCE);
extern void F285_1947(EIF_REFERENCE);
extern void F285_1948(EIF_REFERENCE);
extern EIF_TYPED_VALUE F285_1950(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F285_1944 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 2707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 2707);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F285_1945 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F285_1946 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 2709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 2709);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F285_1947 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 2710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 2710);
	RTIV(Current, RTAL);
...
void F285_1948 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 2711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 2711);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F285_1950 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 284, Current, 2, 1, 2712);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 2712);
	{
