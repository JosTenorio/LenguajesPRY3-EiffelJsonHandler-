...
extern EIF_TYPED_VALUE F268_2653(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F268_2654(EIF_REFERENCE);
extern EIF_TYPED_VALUE F268_2655(EIF_REFERENCE);
extern void F268_5159(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F268_2653 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 267, Current, 2, 1, 4923);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(267, Current, 4923);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tw2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1896, "item", arg1))(arg1)).it_c4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F268_2654 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 267, Current, 0, 0, 4924);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(267, Current, 4924);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F268_2655 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 267, Current, 0, 0, 4925);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {LIST}._invariant */
void F268_5159 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 267, Current, 0, 5158);
	RTSA(dtype);
	RTME(dtype, 0);
