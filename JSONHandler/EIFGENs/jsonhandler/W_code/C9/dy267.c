...
extern void F267_2661(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F267_2662(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F267_2666(EIF_REFERENCE);
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 266, Current, 1, 1, 4973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F267_2661 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 266, Current, 0, 1, 4974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(266, Current, 4974);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1898, "item", arg1))(arg1)).it_c4);
		uw1 = tw1;
...
void F267_2662 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 266, Current, 0, 1, 4975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(266, Current, 4975);
	RTCC(arg1, 266, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F267_2666 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 266, Current, 0, 0, 4972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
