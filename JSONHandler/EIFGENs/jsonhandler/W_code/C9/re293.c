...
extern EIF_TYPED_VALUE F293_2503(EIF_REFERENCE);
extern EIF_TYPED_VALUE F293_2506(EIF_REFERENCE);
extern void F293_5152(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F293_2503 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 292, Current, 0, 0, 3770);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(292, Current, 3770);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F293_5152 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 292, Current, 0, 5151);
	RTSA(dtype);
	RTME(dtype, 0);
