...
extern EIF_TYPED_VALUE F266_1931(EIF_REFERENCE);
...
EIF_TYPED_VALUE F266_1931 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 265, Current, 0, 0, 2699);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(265, Current, 2699);
	RTIV(Current, RTAL);
