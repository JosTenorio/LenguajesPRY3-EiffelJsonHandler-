...
extern EIF_TYPED_VALUE F281_1926(EIF_REFERENCE);
...
EIF_TYPED_VALUE F281_1926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 280, Current, 0, 0, 2694);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(280, Current, 2694);
	RTIV(Current, RTAL);
